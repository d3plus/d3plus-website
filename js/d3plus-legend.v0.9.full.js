...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define('d3plus-legend', ['exports'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}));
  ...
  */
  ...
  var Legend = /*#__PURE__*/function (_BaseClass2) {
    "use strict";

    _inherits2(Legend, _BaseClass2);

    var _super2 = _createSuper2(Legend);
    ...
    */
    function Legend() {
      ...
      _classCallCheck2(this, Legend);

      _this7 = _super2.call(this);
      _this7._align = "center";
      _this7._data = [];
      _this7._direction = "row";
      _this7._duration = 600;
      _this7._height = 200;
      _this7._id = accessor("id");
      _this7._label = accessor("id");
      _this7._lineData = [];
      _this7._outerBounds = {
        width: 0,
        height: 0,
      ...
      _this7._padding = 5;
      _this7._shape = constant$1("Rect");
      _this7._shapes = [];
      _this7._shapeConfig = {
        fill: accessor("color"),
        height: constant$1(10),
        hitArea: function hitArea(dd, i) {
          var d = _this7._lineData[i],
        ...
        width: constant$1(10),
        x: function x(d, i) {
          var datum = _this7._lineData[i];
          var y = datum.y;
          var pad = _this7._align === "left" || _this7._align === "right" && _this7._direction === "column" ? 0 : _this7._align === "center" ? (_this7._outerBounds.width - _this7._rowWidth(_this7._lineData.filter(function (l) {
            return y === l.y;
          }))) / 2 : _this7._outerBounds.width - _this7._rowWidth(_this7._lineData.filter(function (l) {
            return y === l.y;
          }));

          var prevWords = _this7._lineData.slice(0, i).filter(function (l) {
            return y === l.y;
          });

          return _this7._rowWidth(prevWords) + _this7._padding * (prevWords.length ? datum.sentence ? 2 : 1 : 0) + _this7._outerBounds.x + datum.shapeWidth / 2 + pad;
        },
        y: function y(d, i) {
          var ld = _this7._lineData[i];
          return ld.y + _this7._titleHeight + _this7._outerBounds.y + max(_this7._lineData.filter(function (l) {
            return ld.y === l.y;
          }).map(function (l) {
            return l.height;
          }).concat(_this7._data.map(function (l, x) {
            return _this7._fetchConfig("height", l, x);
          }))) / 2;
        }
      };
      _this7._titleClass = new TextBox();
      _this7._titleConfig = {};
      _this7._verticalAlign = "middle";
      _this7._width = 400;
      return _this7;
    }

    _createClass2(Legend, [{
      key: "_fetchConfig",
      ...
      value: function _rowWidth(row) {
        ...
        return sum(row.map(function (d, i) {
          var p = _this8._padding * (i === row.length - 1 ? 0 : d.width ? 2 : 1);
      ...
      value: function render(callback) {
        ...
        if (this._title) {
          var f = this._titleConfig.fontFamily || this._titleClass.fontFamily()(),
              _s2 = this._titleConfig.fontSize || this._titleClass.fontSize()();

          var lH = lH = this._titleConfig.lineHeight || this._titleClass.lineHeight();

          lH = lH ? lH() : _s2 * 1.4;
          var res = textWrap().fontFamily(f).fontSize(_s2).lineHeight(lH).width(this._width).height(this._height)(this._title);
        ...
        this._lineData = this._data.map(function (d, i) {
          var label = _this9._label(d, i);

          var shape = _this9._shape(d, i);

          var r = _this9._fetchConfig("r", d, i);
          ...
          var res = {
            ...
            shape: shape,
            shapeR: r,
            shapeWidth: shape === "Circle" ? r * 2 : _this9._fetchConfig("width", d, i),
            shapeHeight: shape === "Circle" ? r * 2 : _this9._fetchConfig("height", d, i),
            y: 0
          };
          ...
          var f = _this9._fetchConfig("fontFamily", d, i),
              lh = _this9._fetchConfig("lineHeight", d, i),
              s = _this9._fetchConfig("fontSize", d, i);

          var h = availableHeight - (_this9._data.length + 1) * _this9._padding,
              w = _this9._width;
        ...
        if (this._direction === "column" || spaceNeeded > availableWidth) {
          ...
          this._wrapLines = function () {
            ...
            var wrappable = lines === 1 ? this._lineData.slice() : this._lineData.filter(function (d) {
              return d.width + d.shapeWidth + _this10._padding * (d.width ? 2 : 1) > availableWidth && d.words.length >= lines;
            }).sort(function (a, b) {
            ...
            if (wrappable.length && availableHeight > wrappable[0].height * lines) {
              ...
              for (var _x2 = 0; _x2 < wrappable.length; _x2++) {
                var _ret = _loop2(_x2);
          ...
          if (!newRows.length || sum(newRows, this._rowHeight.bind(this)) + this._padding > availableHeight) {
            spaceNeeded = sum(this._lineData.map(function (d) {
              return d.shapeWidth + _this9._padding;
            })) - this._padding;
          ...
          if (newRows.length && sum(newRows, this._rowHeight.bind(this)) + this._padding < availableHeight) {
            newRows.forEach(function (row, i) {
              row.forEach(function (d) {
                if (i) {
                  d.y = sum(newRows.slice(0, i), _this9._rowHeight.bind(_this9));
                }
              });
            });
        ...
        var innerHeight = max(this._lineData, function (d, i) {
          return max([d.height, _this9._fetchConfig("height", d.data, i)]) + d.y;
        }) + this._titleHeight,
        ...
        var data = this._data.map(function (d, i) {
          var obj = {
            ...
            i: i,
            id: _this9._id(d, i),
            label: _this9._lineData[i].width ? _this9._label(d, i) : false,
            lH: _this9._fetchConfig("lineHeight", d, i),
            shape: _this9._shape(d, i)
          };
          return obj;
        }); // Legend Shapes
        ...
        ["Circle", "Rect"].forEach(function (Shape) {
          _this9._shapes.push(new shapes$2[Shape]().parent(_this9).data(data.filter(function (d) {
            return d.shape === Shape;
          })).duration(_this9._duration).labelConfig({
            padding: 0
          }).select(_this9._shapeGroup.node()).verticalAlign("top").config(assign({}, baseConfig, config)).render());
        });
        if (callback) setTimeout(callback, this._duration + 100);
        return this;
      }
  ...
  var formatTypes$1 = {
    ...
    "x": function x(_x3) {
      return Math.round(_x3).toString(16);
    }
  };
  ...
  */
  ...
  function formatAbbreviate(n) {
    ...
    var length = n.toString().split(".")[0].replace("-", "").length,
        localeConfig = _typeof$c(locale) === "object" ? locale : formatLocale$3[locale] || formatLocale$3["en-US"],
      ...
      value: function render(callback) {
        ...
        var tickFormat = this._tickFormat ? this._tickFormat : function (d) {
          ...
          if (isNaN(d)) {
            ...
            var _locale = _typeof$d(_this2._locale) === "object" ? _this2._locale : formatLocale$3[_this2._locale];
  ...
  */
  ...
  var ColorScale = /*#__PURE__*/function (_BaseClass3) {
    "use strict";

    _inherits2(ColorScale, _BaseClass3);

    var _super3 = _createSuper2(ColorScale);
    ...
    */
    function ColorScale() {
      ...
      _classCallCheck2(this, ColorScale);

      _this11 = _super3.call(this);
      _this11._axisClass = new Axis();
      _this11._axisConfig = {
        gridSize: 0,
        shapeConfig: {
          labelConfig: {
      ...
      _this11._axisTest = new Axis();
      _this11._align = "middle";
      _this11._buckets = 5;
      _this11._bucketAxis = false;

      _this11._bucketFormat = function (tick, i, ticks, allValues) {
        var format = _this11._axisConfig.tickFormat ? _this11._axisConfig.tickFormat : formatAbbreviate;
        var next = ticks[i + 1];
        ...
        if (tick === next || last) {
          ...
          var _pow = mod >= 1 || mod <= -1 ? Math.round(mod).toString().length - 1 : mod.toString().split(".")[1].replace(/([1-9])[1-9].*$/, "$1").length * -1;

          var ten = Math.pow(10, _pow);
      ...
      _this11._centered = true;
      _this11._colorMax = "#0C8040";
      _this11._colorMid = "#f7f7f7";
      _this11._colorMin = "#b22200";
      _this11._data = [];
      _this11._duration = 600;
      _this11._height = 200;
      _this11._labelClass = new TextBox();
      _this11._legendClass = new Legend();
      ...
      _this11._midpoint = 0;
      _this11._orient = "bottom";
      _this11._outerBounds = {
        width: 0,
        height: 0,
        x: 0,
        y: 0
      ...
      _this11._padding = 5;
      _this11._rectClass = new Rect().parent(_assertThisInitialized2(_this11));
      _this11._rectConfig = {
        stroke: "#444",
        strokeWidth: 1
      };
      _this11._scale = "linear";
      _this11._size = 10;
      _this11._value = accessor("value");
      _this11._width = 400;
      return _this11;
    }
    /**
    ...
    _createClass2(ColorScale, [{
      ...
      value: function render(callback) {
        ...
        if (this._scale === "jenks") {
          ...
          if (!colors) {
            if (diverging) {
              ...
              var _negatives = ticks.slice(0, buckets).filter(function (d, i) {
                return d < _this12._midpoint && ticks[i + 1] <= _this12._midpoint;
              });
              ...
              colors = range(0, numBuckets, 1).map(function (i) {
                return colorLighter(_this12._colorMax, i / numBuckets);
              }).reverse();
            }
          }
          ...
          var _buckets3 = this._buckets instanceof Array ? this._buckets : undefined;

          if (diverging && !colors) {
            var _half = Math.floor(numBuckets / 2);

            var _negativeColors = range(0, _half, 1).map(function (i) {
              return !i ? _this12._colorMin : colorLighter(_this12._colorMin, i / _half);
            });

            var _spanningColors = (numBuckets % 2 ? [0] : []).map(function () {
              return _this12._colorMid;
            });

            var _positiveColors = range(0, _half, 1).map(function (i) {
              return !i ? _this12._colorMax : colorLighter(_this12._colorMax, i / _half);
            }).reverse();

            colors = _negativeColors.concat(_spanningColors).concat(_positiveColors);

            if (!_buckets3) {
              var _step3 = (colors.length - 1) / 2;

              _buckets3 = [domain[0], this._midpoint, domain[1]];
              _buckets3 = range(domain[0], this._midpoint, -(domain[0] - this._midpoint) / _step3).concat(range(this._midpoint, domain[1], (domain[1] - this._midpoint) / _step3)).concat([domain[1]]);
            }
          } else {
            if (!colors) {
              if (this._scale === "buckets" || this._scale === "quantile") {
                colors = range(0, numBuckets, 1).map(function (i) {
                  return colorLighter(negative ? _this12._colorMin : _this12._colorMax, i / numBuckets);
                });
            ...
            if (!_buckets3) {
              if (this._scale === "quantile") {
                var _step4 = 1 / (colors.length - 1);

                _buckets3 = range(0, 1 + _step4 / 2, _step4).map(function (d) {
                ...
                _buckets3 = negativeBuckets.concat(positiveBuckets);
              } else {
                var _step5 = (domain[1] - domain[0]) / (colors.length - 1);

                _buckets3 = range(domain[0], domain[1] + _step5 / 2, _step5);
              }
            }
          }
          ...
          if (this._scale === "buckets" || this._scale === "quantile") {
            ...
            var _negativeBuckets = _buckets3.filter(function (d) {
              return d < 0;
            });
            ...
            if (_negativeBuckets.length) {
              ...
              _negativeBuckets.forEach(function (bucket, i) {
                _buckets3[_buckets3.indexOf(bucket)] = newNegativeBuckets[i];
              });
            }

            var _positiveBuckets = _buckets3.filter(function (d) {
              return d > 0;
            });
            ...
            if (_positiveBuckets.length) {
              ...
              _positiveBuckets.forEach(function (bucket, i) {
                _buckets3[_buckets3.indexOf(bucket)] = newPositiveBuckets[i];
              });
            }

            if (_buckets3.includes(0)) _buckets3[_buckets3.indexOf(0)] = 1;
          }
        ...
        if (gradient) {
          ...
          if (this._bucketAxis) {
            ...
            var _pow2 = mod >= 1 || mod <= -1 ? Math.round(mod).toString().length - 1 : mod.toString().split(".")[1].replace(/([1-9])[1-9].*$/, "$1").length * -1;

            var ten = Math.pow(10, _pow2);
          ...
          var rectConfig = assign((_assign = {
            ...
            fill: ticks ? function (d) {
              return _this12._colorScale(d);
            } : "url(#gradient-".concat(this._uuid, ")")
          }, _defineProperty2(_assign, x, ticks ? function (d, i) {
            return axisScale(d) + bucketWidth(d, i) / 2 - (["left", "right"].includes(_this12._orient) ? bucketWidth(d, i) : 0);
          } : scaleRange[0] + (scaleRange[1] - scaleRange[0]) / 2 + offsets[x]), _defineProperty2(_assign, y, this._outerBounds[y] + (["top", "left"].includes(this._orient) ? axisBounds[height] : 0) + this._size / 2 + offsets[y]), _defineProperty2(_assign, width, ticks ? bucketWidth : scaleRange[1] - scaleRange[0]), _defineProperty2(_assign, height, this._size), _assign), this._rectConfig);
          ...
          this._labelClass.config(labelConfig).data(labelData).select(labelGroup.node()).x(function (d) {
            return d === _this12._labelMax ? rectConfig.x + rectConfig.width / 2 + _this12._padding : _this12._outerBounds.x;
          }).y(function (d) {
            return rectConfig.y - _this12._labelClass.fontSize()(d) / 2;
          }).text(function (d) {
            return d;
          ...
          var legendData = ticks.reduce(function (arr, tick, i) {
            var label = _this12._bucketFormat.bind(_this12)(tick, i, ticks, allValues);
