...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-scale'), require('d3-selection'), require('d3plus-common')) : typeof define === 'function' && define.amd ? define('d3plus-dev', ['exports', 'd3-scale', 'd3-selection', 'd3plus-common'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.d3plus = {}, global.d3Scale, global.d3Selection, global.d3plusCommon));
})(this, function (exports, d3Scale, d3Selection, d3plusCommon) {
  'use strict';
  ...
  var forOf = function forOf() {
    var n = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 5;
    var arr = new Array(n).fill().map(function (_, i) {
      return i;
    });
    ...
    return {
      size: d3Selection.selectAll("*").size(),
      arr: arr
    };
  };
  ...
  var startsWith = function startsWith(str) {
