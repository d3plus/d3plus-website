  ...
  var loop = function ( i ) {
    ...
    Object.keys(source).forEach(function (prop) {
      ...
      if (isObject$1(value)) {
        ...
        if (target.hasOwnProperty(prop) && isObject$1(target[prop])) { target[prop] = assign$3(target[prop], value); }
        else { target[prop] = value; }
          ...
          value.forEach(function (sourceItem, itemIndex) {
            ...
            if (itemIndex < targetArray.length) {
              ...
              if (isObject$1(targetItem) && isObject$1(sourceItem) || Array.isArray(targetItem) && Array.isArray(sourceItem)) {
                targetArray[itemIndex] = assign$3(targetItem, sourceItem);
              }
              else { targetArray[itemIndex] = sourceItem; }
