...
function(d) {
  ...
  */
  Shape.prototype.transform = function transform (_) {
    return arguments.length
         ? (this._transform = typeof _ === "function" ? _ : constant$5(_), this)
         : this._transform;
  };
...
var Legend = (function (BaseClass$$1) {
  function Legend() {
    ...
    this._shapeConfig = {
      ...
      fontFamily: new Rect$4().fontFamily(),
      fontResize: false,
      fontSize: constant$5(10),
      ...
      extentBounds.features = extentBounds.features.reduce(function (arr, d) {
        ...
        if (d.geometry.coordinates.length > 1) {
          ...
          d.geometry.coordinates.forEach(function (c) {
            ...
            reduced.geometry.coordinates = [c];
            distances.push(pointDistance$1(path.centroid(reduced), center));
...
/**
    ...
    @private
*/
var colorNest$1 = function(raw, fill, groupBy) {
  if ( groupBy === void 0 ) groupBy = [];
...
/**
  ...
  @private
*/
function elementSize$1(element, s) {
  ...
  if (element.tagName === undefined || ["BODY", "HTML"].indexOf(element.tagName) >= 0) {
    ...
    var val$1 = parseFloat(select(element).style(s), 10);
    if (typeof val$1 === "number" && val$1 > 0) return val$1;
    else return elementSize$1(element.parentNode, s);
...
/**
    ...
    @private
*/
var getSize$1 = function(elem) {
  return [elementSize$1(elem, "width"), elementSize$1(elem, "height")];
};
...
/**
    ...
    @desc Creates an x/y plot based on an array of data. If *data* is specified, immediately draws the tree map based on the specified array and returns the current class instance. If *data* is not specified on instantiation, it can be passed/updated after instantiation using the [data](#treemap.data) method. See [this example](https://d3plus.org/examples/d3plus-treemap/getting-started/) for help getting started using the treemap generator.
*/
var Viz$2 = (function (BaseClass$$1) {
  function Viz() {
    var this$1 = this;
    ...
    this._shapeConfig = {
      ...
      opacity: constant$5(1),
      stroke: function (d, i) { return color(assign(this$1._groupBy[0](d, i))).darker(); },
      strokeWidth: constant$5(0)
    };
    this._timeline = true;
    this._timelineClass = new Timeline()
  ...
  */
  Viz.prototype.render = function render (callback) {
    ...
    if (this._legend) {
      ...
      var legend = colorNest$1(this._legendData, this._shapeConfig.fill, this._groupBy);
  ...
  */
  Tree.prototype.render = function render (callback) {
    ...
    */
    ...
    this._shapes.push(new Circle$6()
      .data(treeData)
...
/**
    ...
    @private
*/
var colorNest$2 = function(raw, fill, groupBy) {
  if ( groupBy === void 0 ) groupBy = [];
...
/**
  ...
  @private
*/
function elementSize$2(element, s) {
  ...
  if (element.tagName === undefined || ["BODY", "HTML"].indexOf(element.tagName) >= 0) {
    ...
    var val$1 = parseFloat(select(element).style(s), 10);
    if (typeof val$1 === "number" && val$1 > 0) return val$1;
    else return elementSize$2(element.parentNode, s);
...
/**
    ...
    @private
*/
var getSize$2 = function(elem) {
  return [elementSize$2(elem, "width"), elementSize$2(elem, "height")];
};
...
/**
    ...
    @desc Creates an x/y plot based on an array of data. If *data* is specified, immediately draws the tree map based on the specified array and returns the current class instance. If *data* is not specified on instantiation, it can be passed/updated after instantiation using the [data](#treemap.data) method. See [this example](https://d3plus.org/examples/d3plus-treemap/getting-started/) for help getting started using the treemap generator.
*/
var Viz$4 = (function (BaseClass$$1) {
  function Viz() {
    var this$1 = this;
  ...
  */
  Viz.prototype.render = function render (callback) {
    ...
    // Calculates the width and/or height of the Viz based on the this._select, if either has not been defined.
    if (!this._width || !this._height) {
      var ref$1 = getSize$2(this._select.node());
      var w$1 = ref$1[0];
      var h$1 = ref$1[1];
      if (!this._width) this.width(w$1);
      if (!this._height) this.height(h$1);
    ...
    if (this._legend) {
      ...
      var legend = colorNest$2(this._legendData, this._shapeConfig.fill, this._groupBy);
  ...
  function Plot() {
    ...
    this._shapeConfig = Object.assign(this._shapeConfig, {
      ...
      Line: {
        ...
        label: false,
        stroke: function (d, i) { return assign(this$1._id(d, i)); },
...
/**
    ...
    @private
*/
var colorNest$3 = function(raw, fill, groupBy) {
  if ( groupBy === void 0 ) groupBy = [];
...
/**
  ...
  @private
*/
function elementSize$3(element, s) {
  ...
  if (element.tagName === undefined || ["BODY", "HTML"].indexOf(element.tagName) >= 0) {
    ...
    var val$1 = parseFloat(select(element).style(s), 10);
    if (typeof val$1 === "number" && val$1 > 0) return val$1;
    else return elementSize$3(element.parentNode, s);
...
/**
    ...
    @private
*/
var getSize$3 = function(elem) {
  return [elementSize$3(elem, "width"), elementSize$3(elem, "height")];
};
...
/**
    ...
    @desc Creates an x/y plot based on an array of data. If *data* is specified, immediately draws the tree map based on the specified array and returns the current class instance. If *data* is not specified on instantiation, it can be passed/updated after instantiation using the [data](#treemap.data) method. See [this example](https://d3plus.org/examples/d3plus-treemap/getting-started/) for help getting started using the treemap generator.
*/
var Viz$6 = (function (BaseClass$$1) {
  function Viz() {
    var this$1 = this;
  ...
  */
  Viz.prototype.render = function render (callback) {
    ...
    // Calculates the width and/or height of the Viz based on the this._select, if either has not been defined.
    if (!this._width || !this._height) {
      var ref$1 = getSize$3(this._select.node());
      var w$1 = ref$1[0];
      var h$1 = ref$1[1];
      if (!this._width) this.width(w$1);
      if (!this._height) this.height(h$1);
    ...
    if (this._legend) {
      ...
      var legend = colorNest$3(this._legendData, this._shapeConfig.fill, this._groupBy);
