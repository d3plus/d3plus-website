...
(function (global, factory) {
  ...
  function brush(dim) {
    ...
    function started() {
      ...
      if (event.touches) {
        ...
        var view = _select(event.view).on("keydown.brush", keydowned, true).on("keyup.brush", keyupped, true).on("mousemove.brush", moved, true).on("mouseup.brush", ended, true);
  ...
  */
  ...
  function create$1(node, id, self) {
    ...
    function start(elapsed) {
      ...
      for (i in schedules) {
        ...
        if (o.state === STARTED$1) return timeout$1(start); // Interrupt the active transition, if any.
  ...
  function transition_delay$1 (value) {
    var id = this._id;
    return arguments.length ? this.each((typeof value === "function" ? delayFunction$1 : delayConstant$1)(id, value)) : get$2(this.node(), id).delay;
  }
  ...
  function transition_duration$1 (value) {
    var id = this._id;
    return arguments.length ? this.each((typeof value === "function" ? durationFunction$1 : durationConstant$1)(id, value)) : get$2(this.node(), id).duration;
  }
  ...
  function transition_ease$1 (value) {
    var id = this._id;
    return arguments.length ? this.each(easeConstant$1(id, value)) : get$2(this.node(), id).ease;
  }
  ...
  function transition_on$1 (name, listener) {
    var id = this._id;
    return arguments.length < 2 ? get$2(this.node(), id).on.on(name) : this.each(onFunction$1(id, name, listener));
  }
  ...
  function styleMaybeRemove(id, name) {
    ...
    return function () {
      var schedule = set$3(this, id),
          on = schedule.on,
          listener = schedule.value[key] == null ? remove || (remove = styleRemove$2(name)) : undefined; // If this node shared a dispatch with the previous node,
      // just assign the updated shared dispatch and we’re done!
      // Otherwise, copy-on-write.
  ...
  */
  ...
  function create$2(node, id, self) {
    ...
    function start(elapsed) {
      ...
      for (i in schedules) {
        ...
        if (o.state === STARTED$2) return timeout$1(start); // Interrupt the active transition, if any.
      ...
      self.state = STARTED$2; // Initialize the tween, deleting null tween.
  ...
  function transition_attr$2 (name, value) {
    var fullname = namespace(name),
        i = fullname === "transform" ? interpolateTransformSvg : interpolate$2;
    return this.attrTween(name, typeof value === "function" ? (fullname.local ? attrFunctionNS$3 : attrFunction$3)(fullname, i, tweenValue$2(this, "attr." + name, value)) : value == null ? (fullname.local ? attrRemoveNS$3 : attrRemove$3)(fullname) : (fullname.local ? attrConstantNS$3 : attrConstant$3)(fullname, i, value));
  }
  ...
  var Selection$3 = selection.prototype.constructor;
  ...
  function transition_text$2 (value) {
    return this.tween("text", typeof value === "function" ? textFunction$3(tweenValue$2(this, "text", value)) : textConstant$3(value == null ? "" : value + ""));
  }
  ...
  var selection_prototype$2 = selection.prototype;
  ...
  selection.prototype.interrupt = selection_interrupt$2;
  selection.prototype.transition = selection_transition$2;
    ...
    */
    ...
    _createClass$2(Image, [{
      ...
      value: function render(callback) {
        ...
        var t = transition$2().duration(this._duration),
            that = this,
  ...
  */
  ...
  function stack () {
    ...
    stack.keys = function (_) {
      return arguments.length ? (keys = typeof _ === "function" ? _ : constant$5(slice$1.call(_)), stack) : keys;
    };
    ...
    stack.order = function (_) {
      return arguments.length ? (order = _ == null ? none$2 : typeof _ === "function" ? _ : constant$5(slice$1.call(_)), stack) : order;
    };
  ...
  */
  ...
  function create$3(node, id, self) {
    ...
    function start(elapsed) {
      ...
      for (i in schedules) {
        ...
        if (o.state === STARTED$3) return timeout$1(start); // Interrupt the active transition, if any.
      ...
      self.state = STARTED$3; // Initialize the tween, deleting null tween.
  ...
  function transition_attr$3 (name, value) {
    var fullname = namespace(name),
        i = fullname === "transform" ? interpolateTransformSvg : interpolate$3;
    return this.attrTween(name, typeof value === "function" ? (fullname.local ? attrFunctionNS$4 : attrFunction$4)(fullname, i, tweenValue$3(this, "attr." + name, value)) : value == null ? (fullname.local ? attrRemoveNS$4 : attrRemove$4)(fullname) : (fullname.local ? attrConstantNS$4 : attrConstant$4)(fullname, i, value));
  }
  ...
  function transition_delay$3 (value) {
    var id = this._id;
    return arguments.length ? this.each((typeof value === "function" ? delayFunction$3 : delayConstant$3)(id, value)) : get$4(this.node(), id).delay;
  }
  ...
  function transition_duration$3 (value) {
    var id = this._id;
    return arguments.length ? this.each((typeof value === "function" ? durationFunction$3 : durationConstant$3)(id, value)) : get$4(this.node(), id).duration;
  }
  ...
  function transition_ease$3 (value) {
    var id = this._id;
    return arguments.length ? this.each(easeConstant$3(id, value)) : get$4(this.node(), id).ease;
  }
  ...
  function transition_on$3 (name, listener) {
    var id = this._id;
    return arguments.length < 2 ? get$4(this.node(), id).on.on(name) : this.each(onFunction$3(id, name, listener));
  }
  ...
  var Selection$4 = selection.prototype.constructor;
  ...
  function styleMaybeRemove$2(id, name) {
    ...
    return function () {
      var schedule = set$5(this, id),
          on = schedule.on,
          listener = schedule.value[key] == null ? remove || (remove = styleRemove$4(name)) : undefined; // If this node shared a dispatch with the previous node,
      // just assign the updated shared dispatch and we’re done!
      // Otherwise, copy-on-write.
  ...
  function transition_text$3 (value) {
    return this.tween("text", typeof value === "function" ? textFunction$4(tweenValue$3(this, "text", value)) : textConstant$4(value == null ? "" : value + ""));
  }
  ...
  var TextBox = /*#__PURE__*/function (_BaseClass) {
    ...
    */
    ...
    function TextBox() {
      ...
      _this._ariaHidden = constant$4("false");
      _this._delay = 0;
      _this._duration = 0;
      ...
      _this._fontColor = constant$4("black");
      _this._fontFamily = constant$4(["Roboto", "Helvetica Neue", "HelveticaNeue", "Helvetica", "Arial", "sans-serif"]);
      _this._fontMax = constant$4(50);
      _this._fontMin = constant$4(8);
      _this._fontOpacity = constant$4(1);
      _this._fontResize = constant$4(false);
      _this._fontSize = constant$4(10);
      _this._fontStroke = constant$4("transparent");
      _this._fontStrokeWidth = constant$4(0);
      _this._fontWeight = constant$4(400);
      ...
      _this._maxLines = constant$4(null);
      _this._on = {};
      _this._overflow = constant$4(false);
      _this._padding = constant$4(0);
      _this._pointerEvents = constant$4("auto");
      _this._rotate = constant$4(0);
      ...
      _this._textAnchor = constant$4("start");
      _this._verticalAlign = constant$4("top");
    ...
    _createClass$3(TextBox, [{
      ...
      */
      ...
      value: function ariaHidden(_) {
        return _ !== undefined ? (this._ariaHidden = typeof _ === "function" ? _ : constant$4(_), this) : this._ariaHidden;
      }
      /**
          @memberof TextBox
      ...
      */
      ...
      value: function fontStroke(_) {
        return arguments.length ? (this._fontStroke = typeof _ === "function" ? _ : constant$4(_), this) : this._fontStroke;
      }
      /**
          @memberof TextBox
      ...
      */
      ...
      value: function fontStrokeWidth(_) {
        return arguments.length ? (this._fontStrokeWidth = typeof _ === "function" ? _ : constant$4(_), this) : this._fontStrokeWidth;
      }
      /**
          @memberof TextBox
  ...
  var Shape = /*#__PURE__*/function (_BaseClass) {
    ...
    */
    ...
    function Shape() {
      ...
      _this._ariaLabel = constant$4("");
      _this._backgroundImage = constant$4(false);
      _this._backgroundImageClass = new Image();
      _this._data = [];
      _this._duration = 600;
      _this._fill = constant$4("black");
      _this._fillOpacity = constant$4(1);
      ...
      _this._name = "Shape";
      _this._opacity = constant$4(1);
      _this._pointerEvents = constant$4("visiblePainted");
      _this._role = constant$4("presentation");
      _this._rotate = constant$4(0);
      _this._rx = constant$4(0);
      _this._ry = constant$4(0);
      _this._scale = constant$4(1);
      _this._shapeRendering = constant$4("geometricPrecision");

      _this._stroke = function (d, i) {
        return color$1(_this._fill(d, i)).darker(1);
      };

      _this._strokeDasharray = constant$4("0");
      _this._strokeLinecap = constant$4("butt");
      _this._strokeOpacity = constant$4(1);
      _this._strokeWidth = constant$4(0);
      _this._tagName = tagName;
      _this._textAnchor = constant$4("start");
      _this._vectorEffect = constant$4("non-scaling-stroke");
      _this._verticalAlign = constant$4("top");
      _this._x = accessor("x", 0);
      _this._y = accessor("y", 0);
      return _this;
    ...
    _createClass$4(Shape, [{
      ...
      */
      ...
      value: function render(callback) {
        ...
        this._transition = transition$2().duration(this._duration);
        var data = this._data,
            key = this._id;
      ...
      */
      ...
      value: function ariaLabel(_) {
        return _ !== undefined ? (this._ariaLabel = typeof _ === "function" ? _ : constant$4(_), this) : this._ariaLabel;
      }
      /**
          @memberof Shape
      ...
      */
      ...
      value: function fillOpacity(_) {
        return arguments.length ? (this._fillOpacity = typeof _ === "function" ? _ : constant$4(_), this) : this._fillOpacity;
      }
      /**
          @memberof Shape
          @desc If *value* is specified, sets the highlight accessor to the specified function and returns the current class instance.
      ...
      */
      ...
      value: function role(_) {
        return _ !== undefined ? (this._role = typeof _ === "function" ? _ : constant$4(_), this) : this._role;
      }
      /**
          @memberof Shape
  ...
  var Area = /*#__PURE__*/function (_Shape) {
    ...
    */
    ...
    function Area() {
      ...
      _this._x1 = null;
      _this._y = constant$4(0);
      _this._y0 = constant$4(0);
  ...
  var Line = /*#__PURE__*/function (_Shape) {
    ...
    */
    ...
    function Line() {
      ...
      _this._fill = constant$4("none");
      _this._hitArea = constant$4({
        "d": function d(_d) {
      ...
      _this._name = "Line";
      _this._path = line();
      _this._stroke = constant$4("black");
      _this._strokeWidth = constant$4(1);
      return _this;
    }
    /**
        @memberof Line
  ...
  var Box = /*#__PURE__*/function (_BaseClass) {
    ...
    */
    ...
    function Box() {
      ...
      _this._rectWidth = constant$4(50);
      ...
      value: function render(callback) {
        ...
        var tickFormat = this._tickFormat ? this._tickFormat : function (d) {
          ...
          if (isNaN(d)) {
            ...
            var _locale = _typeof$e(_this2._locale) === "object" ? _this2._locale : formatLocale$2[_this2._locale];
