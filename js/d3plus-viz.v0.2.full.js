...
function(d) {
  ...
  */
  Area.prototype.x0 = function x0 (_) {
    return arguments.length ? (this._x0 = typeof _ === "function" ? _ : constant$4(_), this) : this._x0;
  };
...
function(d) {
  ...
  */
  Area.prototype.y0 = function y0 (_) {
    return arguments.length ? (this._y0 = typeof _ === "function" ? _ : constant$4(_), this) : this._y0;
  };
  ...
  */
  Axis.prototype.render = function render (callback) {
    ...
    if (this._scale === "ordinal" && this._domain.length > range.length) {
      range = sequence(this._domain.length).map(function (d) { return this$1._size * (d / (this$1._domain.length - 1)) + range[0]; });
    }
    ...
    var textData = labels.map(function (d, i) {
      ...
      res.d = d;
      res.fS = s;
      res.width = Math.ceil(max(res.lines.map(function (t) { return measure$1(t, {"font-family": f, "font-size": s}); }))) + s / 4;
...
Shape$1.prototype.backgroundImage = function backgroundImage (_) {
  return arguments.length ? (this._backgroundImage = typeof _ === "function" ? _ : constant$6(_), this) : this._backgroundImage;
};
...
Shape$1.prototype.fill = function fill (_) {
  return arguments.length ? (this._fill = typeof _ === "function" ? _ : constant$6(_), this) : this._fill;
};
...
function(d) {
  ...
  */
  Area.prototype.x0 = function x0 (_) {
    return arguments.length ? (this._x0 = typeof _ === "function" ? _ : constant$6(_), this) : this._x0;
  };
...
function(d) {
  ...
  */
  Area.prototype.y0 = function y0 (_) {
    return arguments.length ? (this._y0 = typeof _ === "function" ? _ : constant$6(_), this) : this._y0;
  };
