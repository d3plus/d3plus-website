...
var Translator = function (_EventEmitter) {
  ...
  Translator.prototype.translate = function translate(keys) {
    ...
    if (res && typeof res !== 'string' && noObject.indexOf(resType) < 0 && !(joinArrays && resType === '[object Array]')) {
      ...
      for (var m in res) {
        copy[m] = this$1.translate('' + key + keySeparator + m, _extends$3({ joinArrays: false, ns: namespaces }, options));
      }
      res = copy;
    }
...
var Area = (function (Shape) {
  ...
  */
  Area.prototype.render = function render (callback) {
    ...
    var areas = nest().key(this._id).entries(this._data).map(function (d) {
  ...
  */
  Legend.prototype.render = function render (callback) {
    ...
    if (this._title) {
      ...
      var res = wrap().fontFamily(f).fontSize(s).lineHeight(lH).width(this._width).height(this._height)(this._title);
    ...
    this._lineData = this._data.map(function (d, i) {
      ...
      var h = availableHeight - (this$1._data.length + 1) * this$1._padding,
            w = this$1._width;
      var res = wrap().fontFamily(f).fontSize(s).lineHeight(lh).width(w).height(h)(this$1._label(d, i));
      res.width = Math.ceil(max(res.lines.map(function (t) { return measure(t, {"font-family": f, "font-size": s}); }))) + s;
...
var splitWords$1 = new RegExp(("[^\\s|\\" + (splitChars$1.join("|\\")) + "]+(\\" + (splitChars$1.join("|\\")) + ")*"), "g");
...
/**
    ...
    @desc Creates a wrapped text box for each point in an array of data. See [this example](https://d3plus.org/examples/d3plus-text/getting-started/) for help getting started using the textBox function.
*/
var TextBox$1 = (function (BaseClass) {
  function TextBox() {
...
var Image$1 = function Image() {
  this._duration = 600;
  this._height = accessor$3("height");
  this._id = accessor$3("url");
  this._select;
  this._url = accessor$3("url");
  this._width = accessor$3("width");
  this._x = accessor$3("x", 0);
  this._y = accessor$3("y", 0);
};
...
/**
    ...
    @private
*/
Shape$1.prototype._aes = function _aes () {
  return {};
};
...
/**
    ...
    @private
*/
Shape$1.prototype._applyEvents = function _applyEvents (update) {
  ...
  hitArea = hitArea.enter().append("rect")
    ...
    .merge(hitArea)
      ...
      .each(function(d) {
        var h = that._hitArea(d, that._data.indexOf(d));
        if (h) select(this).call(attrize$3, h);
        else select(this).remove();
      });
  var handler = this._hitArea ? hitArea : update;
...
/**
    ...
    @private
*/
Shape$1.prototype._applyImage = function _applyImage (g, show) {
    if ( show === void 0 ) show = true;
...
/**
    ...
    @private
*/
Shape$1.prototype._applyLabels = function _applyLabels (g, show) {
    if ( show === void 0 ) show = true;
...
/**
    ...
    @private
*/
Shape$1.prototype._applyStyle = function _applyStyle (elem) {
...
/**
    ...
    @param {Function|String} [*value* = false]
*/
Shape$1.prototype.backgroundImage = function backgroundImage (_) {
...
/**
    ...
    @param {Object} [*value*]
*/
Shape$1.prototype.config = function config (_) {
    var this$1 = this;
...
/**
    ...
    @param {Array} [*data* = []]
*/
Shape$1.prototype.data = function data (_) {
  return arguments.length ? (this._data = _, this) : this._data;
};
...
/**
    ...
    @param {Number} [*ms* = 600]
*/
Shape$1.prototype.duration = function duration (_) {
  return arguments.length ? (this._duration = _, this) : this._duration;
};
...
/**
    ...
    @param {Function|String} [*value* = "black"]
*/
Shape$1.prototype.fill = function fill (_) {
...
/**
    ...
    @param {Function|String|Array} [*value*]
*/
Shape$1.prototype.fontColor = function fontColor (_) {
...
/**
    ...
    @param {Function|String|Array} [*value* = "Verdana"]
*/
Shape$1.prototype.fontFamily = function fontFamily (_) {
...
/**
    ...
    @param {Function|Boolean|Array} [*value*]
*/
Shape$1.prototype.fontResize = function fontResize (_) {
...
/**
    ...
    @param {Function|String|Array} [*value* = 12]
*/
Shape$1.prototype.fontSize = function fontSize (_) {
...
*/
Shape$1.prototype.hitArea = function hitArea (_) {
...
/**
    ...
    @param {Function} [*value*]
*/
Shape$1.prototype.id = function id (_) {
  return arguments.length ? (this._id = _, this) : this._id;
};
...
/**
    ...
    @param {Function|String|Array} [*value*]
*/
Shape$1.prototype.label = function label (_) {
...
*/
Shape$1.prototype.labelBounds = function labelBounds (_) {
...
/**
    ...
    @param {Function|Number|Array} [*value* = 10]
*/
Shape$1.prototype.labelPadding = function labelPadding (_) {
...
/**
    ...
    @param {Function|String|Array} [*value*]
*/
Shape$1.prototype.lineHeight = function lineHeight (_) {
...
/**
    ...
    @param {Function} [*listener*]
*/
Shape$1.prototype.on = function on (_, f) {
  return arguments.length === 2 ? (this._on[_] = f, this) : arguments.length ? typeof _ === "string" ? this._on[_] : (this._on = Object.assign({}, this._on, _), this) : this._on;
};
...
/**
    ...
    @param {Number} [*value* = 1]
*/
Shape$1.prototype.opacity = function opacity (_) {
...
/**
    ...
    @param {Function} [*callback* = undefined]
*/
Shape$1.prototype.render = function render (callback) {
    var this$1 = this;
...
/**
    ...
    @param {Function|Number} [*value* = 1]
*/
Shape$1.prototype.scale = function scale (_) {
...
/**
    ...
    @param {String|HTMLElement} [*selector* = d3.select("body").append("svg")]
*/
Shape$1.prototype.select = function select$1 (_) {
  return arguments.length ? (this._select = select(_), this) : this._select;
};
...
/**
    ...
    @param {Function|String} [*value* = "black"]
*/
Shape$1.prototype.stroke = function stroke (_) {
...
/**
    ...
    @param {Function|Number} [*value* = 0]
*/
Shape$1.prototype.strokeWidth = function strokeWidth (_) {
...
/**
    ...
    @param {Function|String|Array} [*value* = "start"]
*/
Shape$1.prototype.textAnchor = function textAnchor (_) {
...
/**
    ...
    @param {Function|String|Array} [*value* = "start"]
*/
Shape$1.prototype.verticalAlign = function verticalAlign (_) {
...
var Area$1 = (function (Shape) {
  function Area() {
    ...
    this._curve = "linear";
    this._x = accessor$3("x");
    this._x0 = accessor$3("x");
    this._x1 = null;
    this._y = constant$10(0);
    this._y0 = constant$10(0);
    this._y1 = accessor$3("y");
  ...
  */
  Area.prototype.render = function render (callback) {
    ...
    var enter = groups.enter().append("g")
        .attr("class", function (d) { return ("d3plus-Shape d3plus-Area d3plus-id-" + (strip$1(d.key))); })
        .attr("transform", function (d) { return ("translate(" + (d.x) + ", " + (d.y) + ")"); })
        .attr("opacity", 0);
...
var Circle$1 = (function (Shape) {
  function Circle() {
    Shape.call(this);
    this._r = accessor$3("r");
    this._x = accessor$3("x");
    this._y = accessor$3("y");
  }
  ...
  */
  Circle.prototype.render = function render (callback) {
    ...
    var enter = groups.enter().append("g")
        .attr("class", function (d, i) { return ("d3plus-Shape d3plus-Circle d3plus-id-" + (strip$1(this$1._id(d, i)))); })
        .attr("transform", function (d, i) { return ("translate(" + (this$1._x(d, i)) + "," + (this$1._y(d, i)) + ")"); });
...
var Line$1 = (function (Shape) {
  ...
  */
  Line.prototype.render = function render (callback) {
    ...
    var enter = groups.enter().append("g")
        .attr("class", function (d) { return ("d3plus-Shape d3plus-Line d3plus-id-" + (strip$1(d.key))); })
        .attr("transform", function (d) { return ("translate(" + (d.x) + ", " + (d.y) + ")"); })
        .attr("opacity", 0);
...
var Rect$1 = (function (Shape) {
  ...
  */
  Rect.prototype.render = function render (callback) {
    ...
    var enter = groups.enter().append("g")
        .attr("class", function (d, i) { return ("d3plus-Shape d3plus-Rect d3plus-id-" + (strip$1(this$1._id(d, i)))); })
        .attr("transform", function (d, i) { return ("translate(" + (this$1._x(d, i)) + "," + (this$1._y(d, i)) + ")"); });
...
var TextBox$2 = (function (BaseClass) {
  function TextBox() {
    ...
    this._duration = 0;
    this._ellipsis = function (_) { return ((_.replace(/\.|,$/g, "")) + "..."); };
    this._fontColor = constant$9("black");
    this._fontFamily = constant$9("Verdana");
    this._fontMax = constant$9(50);
    this._fontMin = constant$9(8);
    this._fontResize = constant$9(false);
    this._fontSize = constant$9(10);
    this._height = accessor$2("height", 200);
    this._id = function (d, i) { return d.id || ("" + i); };
    this._on = {};
    this._overflow = constant$9(false);
    this._rotate = constant$9(0);
    this._split = textSplit$1;
    this._text = accessor$2("text");
    this._textAnchor = constant$9("start");
    this._verticalAlign = constant$9("top");
...
function(d) {
  ...
  */
  TextBox.prototype.ellipsis = function ellipsis (_) {
    return arguments.length ? (this._ellipsis = typeof _ === "function" ? _ : constant$9(_), this) : this._ellipsis;
  };
  ...
  */
  TextBox.prototype.fontColor = function fontColor (_) {
    return arguments.length ? (this._fontColor = typeof _ === "function" ? _ : constant$9(_), this) : this._fontColor;
  };
  ...
  */
  TextBox.prototype.fontFamily = function fontFamily (_) {
    return arguments.length ? (this._fontFamily = typeof _ === "function" ? _ : constant$9(_), this) : this._fontFamily;
  };
  ...
  */
  TextBox.prototype.fontMax = function fontMax (_) {
    return arguments.length ? (this._fontMax = typeof _ === "function" ? _ : constant$9(_), this) : this._fontMax;
  };
  ...
  */
  TextBox.prototype.fontMin = function fontMin (_) {
    return arguments.length ? (this._fontMin = typeof _ === "function" ? _ : constant$9(_), this) : this._fontMin;
  };
  ...
  */
  TextBox.prototype.fontResize = function fontResize (_) {
    return arguments.length ? (this._fontResize = typeof _ === "function" ? _ : constant$9(_), this) : this._fontResize;
  };
  ...
  */
  TextBox.prototype.fontSize = function fontSize (_) {
    return arguments.length ? (this._fontSize = typeof _ === "function" ? _ : constant$9(_), this) : this._fontSize;
  };
...
function(d) {
  ...
  */
  TextBox.prototype.height = function height (_) {
    return arguments.length ? (this._height = typeof _ === "function" ? _ : constant$9(_), this) : this._height;
  };
...
function(d, i) {
  ...
  */
  TextBox.prototype.id = function id (_) {
    return arguments.length ? (this._id = typeof _ === "function" ? _ : constant$9(_), this) : this._id;
  };
  ...
  */
  TextBox.prototype.lineHeight = function lineHeight (_) {
    return arguments.length ? (this._lineHeight = typeof _ === "function" ? _ : constant$9(_), this) : this._lineHeight;
  };
  ...
  */
  TextBox.prototype.overflow = function overflow (_) {
    return arguments.length ? (this._overflow = typeof _ === "function" ? _ : constant$9(_), this) : this._overflow;
  };
  ...
  */
  TextBox.prototype.rotate = function rotate (_) {
    return arguments.length ? (this._rotate = typeof _ === "function" ? _ : constant$9(_), this) : this._rotate;
  };
...
function(d) {
  ...
  */
  TextBox.prototype.text = function text (_) {
    return arguments.length ? (this._text = typeof _ === "function" ? _ : constant$9(_), this) : this._text;
  };
  ...
  */
  TextBox.prototype.textAnchor = function textAnchor (_) {
    return arguments.length ? (this._textAnchor = typeof _ === "function" ? _ : constant$9(_), this) : this._textAnchor;
  };
  ...
  */
  TextBox.prototype.verticalAlign = function verticalAlign (_) {
    return arguments.length ? (this._verticalAlign = typeof _ === "function" ? _ : constant$9(_), this) : this._verticalAlign;
  };
...
function(d) {
  ...
  */
  TextBox.prototype.width = function width (_) {
    return arguments.length ? (this._width = typeof _ === "function" ? _ : constant$9(_), this) : this._width;
  };
...
function(d) {
  ...
  */
  TextBox.prototype.x = function x (_) {
    return arguments.length ? (this._x = typeof _ === "function" ? _ : constant$9(_), this) : this._x;
  };
...
function(d) {
  ...
  */
  TextBox.prototype.y = function y (_) {
    return arguments.length ? (this._y = typeof _ === "function" ? _ : constant$9(_), this) : this._y;
  };
  ...
  */
  Axis.prototype.render = function render (callback) {
    ...
    if (this._scale !== "band" && textData.length) {
      ...
      var firstB = min([this._d3Scale(first.d) - first[width] / 2, range[0] - wBuff]);
      if (firstB < range[0]) {
      ...
      var lastB = max([this._d3Scale(last.d) + last[width] / 2, range[lastI] + wBuff]);
...
var Timeline = (function (Axis) {
  ...
  Timeline.prototype._brushEnd = function _brushEnd () {
    ...
    domain[0] = date$2(closest$4(domain[0], ticks));
    domain[1] = date$2(closest$4(domain[1], ticks));
  ...
  */
  Timeline.prototype.render = function render (callback) {
    ...
    var brushGroup = this._brushGroup = elem$4("g.brushGroup", {parent: this._group});
    ...
    brushGroup.selectAll(".handle").transition(this._transition)
      .call(attrize$4, this._handleConfig);
...
function prefix$6() {
  if (val$5 !== void 0) return val$5;
  if ("-webkit-transform" in document.body.style) val$5 = "-webkit-";
  else if ("-moz-transform" in document.body.style) val$5 = "-moz-";
  else if ("-ms-transform" in document.body.style) val$5 = "-ms-";
  else if ("-o-transform" in document.body.style) val$5 = "-o-";
  else val$5 = "";
  return val$5;
}
...
function tooltip(data) {
  ...
  */
  ...
  var background = constant$4("rgba(255, 255, 255, 0.75)"),
      ...
      border = constant$4("1px solid rgba(0, 0, 0, 0.1)"),
      borderRadius = constant$4("2px"),
      className = "d3plus-tooltip",
      duration = constant$4(200),
      ...
      height = constant$4("auto"),
      id = tooltipId,
      offset = constant$4(10),
      padding = constant$4("5px"),
      pointerEvents = constant$4("auto"),
      tableStyle = {
        "border-spacing": "0",
        "width": "100%"
      },
  ...
  */
  tooltip.background = function(_) {
    return arguments.length ? (background = typeof _ === "function" ? _ : constant$4(_), tooltip) : background;
  };
...
function value(d) {
  ...
  */
  tooltip.body = function(_) {
    return arguments.length ? (body = typeof _ === "function" ? _ : constant$4(_), tooltip) : body;
  };
      ...
      @example <caption>default styles</caption>
{
  ...
  */
  tooltip.border = function(_) {
    return arguments.length ? (border = typeof _ === "function" ? _ : constant$4(_), tooltip) : border;
  };
  ...
  */
  tooltip.borderRadius = function(_) {
    return arguments.length ? (borderRadius = typeof _ === "function" ? _ : constant$4(_), tooltip) : borderRadius;
  };
  ...
  */
  tooltip.duration = function(_) {
    return arguments.length ? (duration = typeof _ === "function" ? _ : constant$4(_), tooltip) : duration;
  };
...
function value(d) {
  ...
  */
  tooltip.footer = function(_) {
    return arguments.length ? (footer = typeof _ === "function" ? _ : constant$4(_), tooltip) : footer;
  };
      ...
      @example <caption>default styles</caption>
{
  ...
  */
  tooltip.height = function(_) {
    return arguments.length ? (height = typeof _ === "function" ? _ : constant$4(_), tooltip) : height;
  };
...
function value(d, i) {
  ...
  */
  tooltip.id = function(_) {
    return arguments.length ? (id = typeof _ === "function" ? _ : constant$4(_), tooltip) : id;
  };
  ...
  */
  tooltip.offset = function(_) {
    return arguments.length ? (offset = typeof _ === "function" ? _ : constant$4(_), tooltip) : offset;
  };
  ...
  */
  tooltip.padding = function(_) {
    return arguments.length ? (padding = typeof _ === "function" ? _ : constant$4(_), tooltip) : padding;
  };
  ...
  */
  tooltip.pointerEvents = function(_) {
    return arguments.length ? (pointerEvents = typeof _ === "function" ? _ : constant$4(_), tooltip) : pointerEvents;
  };
...
function value(d) {
  ...
  */
  tooltip.title = function(_) {
    return arguments.length ? (title = typeof _ === "function" ? _ : constant$4(_), tooltip) : title;
  };
...
function value(d) {
  ...
  */
  tooltip.translate = function(_) {
    return arguments.length ? (translate = typeof _ === "function" ? _ : constant$4(_), tooltip) : translate;
  };
  ...
  */
  tooltip.width = function(_) {
    return arguments.length ? (width = typeof _ === "function" ? _ : constant$4(_), tooltip) : width;
  };
...
function value(d) {
  ...
  */
  Viz.prototype.highlight = function highlight (_) {
    var ids = _ ? Array.from(new Set(this._data.filter(_).map(this._id))).map(strip$1) : [];
