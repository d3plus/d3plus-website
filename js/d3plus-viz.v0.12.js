  ...
  function mouseenter (d, i) {
    ...
    if (this._shapeConfig.hoverOpacity !== 1) {
      ...
      this.hover(function (h, x) {
        ...
        var index = d3Array.min([ids.length - 1, filterId.length - 1, _this._drawDepth]);
  ...
  */
  ...
  function mousemoveShape (d, i, x) {
    if (this._tooltip && d) {
      ...
      this._tooltipClass.data([x || d]).footer(this._drawDepth < this._groupBy.length - 1 ? "Click to Expand" : "").title(this._drawLabel).position(position).config(d3plusCommon.configPrep.bind(this)(this._tooltipConfig)).render();
    }
  }
  ...
  function (_BaseClass) {
    ...
    */
    function Viz() {
      ...
      _this._noDataHTML = d3plusCommon.constant("\n    <div style=\"font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif;\">\n      <strong>No Data Available</strong>\n    </div>");
      ...
      _this._totalFormat = function (d) {
        return "Total: ".concat(d3plusFormat.formatAbbreviate(d, _this._locale));
      };
    ...
    _createClass(Viz, [{
      ...
      value: function _preDraw() {
        ...
        this._drawLabel = function (d, i) {
          ...
          if (d._isAggregation) {
            return "".concat(_this2._thresholdName, " < ").concat(d3plusFormat.formatAbbreviate(d._threshold * 100, _this2._locale), "%");
          }
