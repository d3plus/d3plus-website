  ...
  if (groupBy.length) {
    ...
    var loop = function ( i ) {
      ...
      if (total === numColors && uniques === numColors || i === groupBy.length - 1) {
        id = groupBy[i];
        data = nest$1().key(id).entries(raw).map(function (d) { return objectMerge$1(d.values); });
        return 'break';
      }
    };
    ...
    id = fill;
    data = colors.map(function (d) { return objectMerge$1(d.values); });
  }
...
var Viz = (function (BaseClass$$1) {
  ...
  */
  Viz.prototype._shapeConfigPrep = function _shapeConfigPrep (shape) {
    ...
    if (shape && this._shapeConfig[shape]) { newConfig = assign$2(newConfig, this._shapeConfig[shape]); }
    return newConfig;
  ...
  */
  Viz.prototype._uiGroup = function _uiGroup (type, condition) {
    ...
    return elem$1(("g.d3plus-viz-" + type), {
      condition: condition,
  ...
  */
  Viz.prototype.render = function render (callback) {
    ...
    if (this._data.length) {
      ...
      dataNest.rollup(function (leaves) { return this$1._legendData.push(objectMerge$1(leaves, this$1._aggs)); }).entries(data);
      if (this._discrete && ("_" + (this._discrete)) in this) { dataNest.key(this[("_" + (this._discrete))]); }
      dataNest.rollup(function (leaves) { return this$1._filteredData.push(objectMerge$1(leaves, this$1._aggs)); }).entries(data);
    ...
    var titleGroup = elem$1("g.d3plus-viz-titles", {parent: this._select});
  ...
  */
  Viz.prototype.aggs = function aggs (_) {
    return arguments.length ? (this._aggs = assign$2(this._aggs, _), this) : this._aggs;
  };
...
function value(d) {
  ...
  Viz.prototype.highlight = function highlight (_) {
    ...
    function opacity(group) {
      group.selectAll(".d3plus-Shape")
        .style(((prefix$2()) + "transition"), ("opacity " + (that._tooltipClass.duration() / 1000) + "s"))
  ...
  */
  Viz.prototype.shapeConfig = function shapeConfig (_) {
    return arguments.length ? (this._shapeConfig = assign$2(this._shapeConfig, _), this) : this._shapeConfig;
  };
  ...
  */
  Viz.prototype.timelineConfig = function timelineConfig (_) {
    return arguments.length ? (this._timelineConfig = assign$2(this._timelineConfig, _), this) : this._timelineConfig;
  };
  ...
  */
  Viz.prototype.tooltipConfig = function tooltipConfig (_) {
    return arguments.length ? (this._tooltipConfig = assign$2(this._tooltipConfig, _), this) : this._tooltipConfig;
  };
...
var treemap = function() {
  ...
  treemap.paddingInner = function(x) {
    return arguments.length ? (paddingInner = typeof x === "function" ? x : constant$12(+x), treemap) : paddingInner;
  };
  ...
  treemap.paddingTop = function(x) {
    return arguments.length ? (paddingTop = typeof x === "function" ? x : constant$12(+x), treemap) : paddingTop;
  };

  treemap.paddingRight = function(x) {
    return arguments.length ? (paddingRight = typeof x === "function" ? x : constant$12(+x), treemap) : paddingRight;
  };

  treemap.paddingBottom = function(x) {
    return arguments.length ? (paddingBottom = typeof x === "function" ? x : constant$12(+x), treemap) : paddingBottom;
  };

  treemap.paddingLeft = function(x) {
    return arguments.length ? (paddingLeft = typeof x === "function" ? x : constant$12(+x), treemap) : paddingLeft;
  };
...
var threshold$1 = function(array, p, f) {
...
Map$1.prototype = map$5.prototype = {
  constructor: Map$1,
  has: function(key) {
  ...
  clear: function() {
    ...
    for (var property in this) { if (property[0] === prefix$3) { delete this$1[property]; } }
  },
  keys: function() {
    var keys = [];
  ...
  values: function() {
    ...
    var values = [];
    for (var property in this) { if (property[0] === prefix$3) { values.push(this$1[property]); } }
    return values;
  },
  entries: function() {
    var this$1 = this;
    ...
    var entries = [];
    for (var property in this) { if (property[0] === prefix$3) { entries.push({key: property.slice(1), value: this$1[property]}); } }
    return entries;
  },
  size: function() {
    var size = 0;
  ...
  each: function(f) {
    ...
    for (var property in this) { if (property[0] === prefix$3) { f(this$1[property], property.slice(1), this$1); } }
  }
};
...
function continuous$1(deinterpolate, reinterpolate) {
  ...
  scale.domain = function(_) {
    return arguments.length ? (domain = map$7.call(_, number$4), rescale()) : domain.slice();
  };
...
function identity$10() {
  ...
  scale.domain = scale.range = function(_) {
    return arguments.length ? (domain = map$7.call(_, number$4), scale) : domain.slice();
  };
...
function pow$2() {
  ...
  scale.copy = function() {
    return copy$2(scale, pow$2().exponent(exponent));
  };
...
function calendar$1(year$$1, month$$1, week, day$$1, hour$$1, minute$$1, second$$1, millisecond$$1, format) {
  ...
  scale.domain = function(_) {
    return arguments.length ? domain(map$7.call(_, number$5)) : domain().map(date$3);
  };
  ...
  scale.copy = function() {
    return copy$2(scale, calendar$1(year$$1, month$$1, week, day$$1, hour$$1, minute$$1, second$$1, millisecond$$1, format));
  };
...
var scales$1 = Object.freeze({
	scaleBand: band$1,
	scalePoint: point$7,
	scaleIdentity: identity$10,
...
Selection$2.prototype = selection$3.prototype = {
...
var LineBuffer = function(data, x, y) {
  ...
  var b = s.invert(s(max$1(vals)) + (this._discrete === "x" ? -10 : 10));
  ...
  */
  Plot.prototype.render = function render (callback) {
    ...
    if (this._stacked) {
      ...
      domains = {};
      domains[this._discrete] = extent$2(data, function (d) { return d[this$1._discrete]; });
      domains[opp] = [min$1(stackData.map(function (g) { return min$1(g.map(function (p) { return p[1]; })); })), max$1(stackData.map(function (g) { return max$1(g.map(function (p) { return p[1]; })); }))];

    }
    else { domains = {x: extent$2(data, function (d) { return d.x; }), y: extent$2(data, function (d) { return d.y; })}; }
    ...
    var x = scales$1[("scale" + (xTime ? "Time" : "Linear"))]().domain(domains.x).range([0, width]),
        y = scales$1[("scale" + (yTime ? "Time" : "Linear"))]().domain(domains.y.reverse()).range([0, height]);

    var shapeData = nest$3().key(function (d) { return d.shape; }).entries(data);
    ...
    function mouseEvent(d) {
      ...
      if (d.nested && d.values) {
        var axis = that._discrete,
              cursor = mouse$1(that._select.node())[axis === "x" ? 0 : 1],
...
var Priestley = (function (Viz$$1) {
  ...
  */
  Priestley.prototype.render = function render (callback) {
    ...
    this._axisTest
      ...
      .select(elem$2("g.d3plus-priestley-axis-test", {parent: this._select, enter: {opacity: 0}}).node())
      .render();

    this._axis
      .config(axisConfig)
      .config(this._axisConfig)
      .select(elem$2("g.d3plus-priestley-axis", {parent: this._select, enter: {transform: transform}, update: {transform: transform}}).node())
      .render();
    ...
    this._shapes.push(new Rect()
      ...
      .select(elem$2("g.d3plus-priestley-shapes", {parent: this._select}).node())
      .width(function (d) {
  ...
  */
  Priestley.prototype.axisConfig = function axisConfig (_) {
    return arguments.length ? (this._axisConfig = assign$4(this._axisConfig, _), this) : this._axisConfig;
  };
