  ...
  function textBox(data) {
    ...
    */
    function textBox(callback) {
      ...
      if (select === void 0) textBox.select(d3$2.select("body").append("svg").style("width", ((window.innerWidth) + "px")).style("height", ((window.innerHeight) + "px")).node());
  ...
  function(d, i) {
    ...
    */
    textBox.select = function(_) {
      return arguments.length ? (select = d3$2.select(_), textBox) : select;
    };
