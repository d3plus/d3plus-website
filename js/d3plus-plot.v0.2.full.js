...
var Image = function Image() {
  this._duration = 600;
  this._height = accessor$2("height");
  this._id = accessor$2("url");
  this._select;
  this._url = accessor$2("url");
  this._width = accessor$2("width");
  ...
  hitArea = hitArea.enter().append("rect")
    ...
    .merge(hitArea)
      ...
      .each(function(d) {
        ...
        if (h) select(this).call(attrize$2, h);
...
var Area$1 = (function (Shape) {
  function Area() {
    ...
    this._curve = "linear";
    this._x = accessor$2("x");
    this._x0 = accessor$2("x");
    this._x1 = null;
    this._y = constant$7(0);
    this._y0 = constant$7(0);
    this._y1 = accessor$2("y");
...
var Circle = (function (Shape) {
  function Circle() {
    Shape.call(this);
    this._r = accessor$2("r");
    this._x = accessor$2("x");
    this._y = accessor$2("y");
  }
...
{"width": 180, "height": 24, "x": 10, "y": 20}
  ...
  */
  Axis.prototype.render = function render (callback) {
    ...
    var tickScale = scaleSqrt().domain([10, 400]).range([10, this._gridSize === 0 ? 32.5 : 75]);
    var labelScale = scaleSqrt().domain([10, 400]).range([10, 75]);
...
function tooltip(data) {
  ...
  */
  ...
  var background = constant("rgba(255, 255, 255, 0.75)"),
      body = accessor("body", ""),
      bodyStyle = {
        "font-family": "Verdana",
        "font-size": "10px",
  ...
  Plot.prototype.render = function render (callback) {
    ...
    if (this._stacked) {
      ...
      stackData = stack()
        ...
        (nest().key(function (d) { return d[this$1._discrete]; }).entries(data).map(function (d) { return d.values; }));
    ...
    var x = linear$2().domain(domains.x).range([0, width]),
        y = linear$2().domain(domains.y.reverse()).range([0, height]);
