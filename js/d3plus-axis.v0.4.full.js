...
(function (global, factory) {
  ...
  function transformer() {
    ...
    scale.invert = function(y) {
      return clamp(untransform((input || (input = piecewise$$1(range$$1, domain.map(transform), number$1)))(y)));
    };
    ...
    Axis.prototype.render = function render (callback) {
      ...
      var tickFormat$$1 = this._tickFormat ? this._tickFormat : function (d) {
        ...
        if (isNaN(n)) {
          ...
          var locale = typeof this$1._locale === "object" ? this$1._locale : defaultLocale$2[this$1._locale];
