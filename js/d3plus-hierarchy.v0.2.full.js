...
var drawTotal = function(data) {
  ...
  var total = typeof this._total === "function" ? sum$1(data.map(this._total))
              : this._total === true && this._size ? sum$1(data.map(this._size)) : false;
