...
var 	reHslaPercent$1 = /^hsla\(\s*([-+]?\d+(?:\.\d+)?)\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/;
	...
	define$1(Rgb$1, colorRgb, extend$1(Color$1, {
	  brighter: function(k) {
	...
	define$1(Hsl$1, colorHsl, extend$1(Color$1, {
	  brighter: function(k) {
	    k = k == null ? brighter$1 : Math.pow(brighter$1, k);
...
var 	t3$1 = t1$1 * t1$1 * t1$1;
	...
	define$1(Hcl$1, colorHcl, extend$1(Color$1, {
	  brighter: function(k) {
...
var 	BC_DA$1 = B$1 * C$1 - D$1 * A$1;
	...
	cubehelix$2(hue);
	var interpolateCubehelixLong = cubehelix$2(nogamma);
...
var 	BC_DA$2 = B$2 * C$2 - D$2 * A$2;
	...
	interpolateCubehelixLong(cubehelix$5(300, 0.5, 0.0), cubehelix$5(-240, 0.5, 1.0));

	var warm = interpolateCubehelixLong(cubehelix$5(-100, 0.75, 0.35), cubehelix$5(80, 1.50, 0.8));

	var cool = interpolateCubehelixLong(cubehelix$5(260, 0.75, 0.35), cubehelix$5(80, 1.50, 0.8));
