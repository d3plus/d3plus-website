...
var Tooltip = (function (BaseClass$$1) {
  function Tooltip() {
    ...
    this._footer = accessor$4("footer", "");
    this._footerStyle = {
      "font-family": "Verdana",
      "font-size": "10px",
      "font-weight": "400"
  ...
  Tooltip.prototype.render = function render (callback) {
    ...
    */
    function divElement(cat) {
      ...
      stylize$4(div, that[("_" + cat + "Style")]);
    }
    ...
    */
    ...
    stylize$4(tableBody, this._tbodyStyle);
