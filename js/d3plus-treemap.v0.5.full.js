...
Shape.prototype.labelPadding = function labelPadding (_) {
  return arguments.length ? (this._labelPadding = typeof _ === "function" ? _ : constant$1(_), this) : this._labelPadding;
};
...
function elem$1(selector, p) {
  ...
  p = Object.assign({}, defaultParams$1, p);
...
Image$1.prototype.render = function render (callback) {
  ...
  var t = d3$3.transition().duration(this._duration),
        that = this,
        update = enter.merge(images);
  ...
  update
    ...
    .transition(t)
      ...
      .attr("y", function (d, i) { return this$1._y(d, i); })
      .each(function(d, i) {
        var image = d3$3.select(this), link = that._url(d, i);
        var fullAddress = link.indexOf("http://") === 0 || link.indexOf("https://") === 0;
        if (!fullAddress || link.indexOf(window.location.hostname) === 0) {
          var img = new Image$1();
          img.src = link;
...
Shape$1.prototype.render = function render (callback) {
  ...
  this._transition = d3$2.transition().duration(this._duration);
...
Image$2.prototype.render = function render (callback) {
  ...
  if (this._select === void 0) this.select(d3$5.select("body").append("svg").style("width", ((window.innerWidth) + "px")).style("height", ((window.innerHeight) + "px")).style("display", "block").node());
  ...
  var t = d3$5.transition().duration(this._duration),
        that = this,
        update = enter.merge(images);
  ...
  update
    ...
    .transition(t)
      ...
      .attr("y", function (d, i) { return this$1._y(d, i); })
      .each(function(d, i) {
        var image = d3$5.select(this), link = that._url(d, i);
        var fullAddress = link.indexOf("http://") === 0 || link.indexOf("https://") === 0;
        if (!fullAddress || link.indexOf(window.location.hostname) === 0) {
          var img = new Image$2();
          img.src = link;
...
/**
    ...
    @param {String|HTMLElement} [*selector* = d3.select("body").append("svg")]
*/
Image$2.prototype.select = function select (_) {
  return arguments.length ? (this._select = d3$5.select(_), this) : this._select;
};
...
/**
    ...
    @private
*/
Shape$2.prototype._applyStyle = function _applyStyle (elem) {
    var this$1 = this;
...
Shape$2.prototype.render = function render (callback) {
  ...
  this._transition = d3$4.transition().duration(this._duration);
...
/**
    ...
    @param {String|HTMLElement} [*selector* = d3.select("body").append("svg")]
*/
Shape$2.prototype.select = function select (_) {
...
{"width": 180, "height": 24, "x": 10, "y": 20}
  ...
  */
  Axis.prototype.render = function render (callback) {
    ...
    var tickScale = scaleSqrt().domain([10, 400]).range([10, this._gridSize === 0 ? 25 : 50]);
    var labelScale = scaleSqrt().domain([10, 400]).range([10, 50]);
    ...
    if (textData.length) {
      ...
      var lastB = max([this._d3Scale(last.d) + last[width] / 2, range[1] + wBuff]);
      if (lastB > range[1]) {
...
function tooltip(data) {
  ...
  function boxStyles(box) {
    box
      ...
      .style("border", function(d, i) {
        var b = d3$6.select(this).style("border");
  ...
  */
  function cellContent(d) {
    if (typeof d === "function") {
      var datum = d3$6.select(this.parentNode.parentNode).datum();
  ...
  var background = constant$1("rgba(255, 255, 255, 0.75)"),
      ...
      border = constant$1("1px solid rgba(0, 0, 0, 0.1)"),
      borderRadius = constant$1("2px"),
      ...
      height = constant$1("auto"),
      id = tooltipId,
      offset = constant$1(10),
      padding = constant$1("5px"),
      pointerEvents = constant$1("auto"),
      tableStyle = {
        "border-spacing": "0",
        "width": "100%"
      },
  ...
  */
  function tooltip(callback) {
    ...
    var tooltips = d3$6.select("body").selectAll(("." + className))
      .data(data, id);
  ...
  */
  tooltip.background = function(_) {
    return arguments.length ? (background = typeof _ === "function" ? _ : constant$1(_), tooltip) : background;
  };
...
function value(d) {
  ...
  */
  tooltip.body = function(_) {
    return arguments.length ? (body = typeof _ === "function" ? _ : constant$1(_), tooltip) : body;
  };
      ...
      @example <caption>default styles</caption>
{
  ...
  */
  tooltip.border = function(_) {
    return arguments.length ? (border = typeof _ === "function" ? _ : constant$1(_), tooltip) : border;
  };
  ...
  */
  tooltip.borderRadius = function(_) {
    return arguments.length ? (borderRadius = typeof _ === "function" ? _ : constant$1(_), tooltip) : borderRadius;
  };
  ...
  */
  tooltip.duration = function(_) {
    return arguments.length ? (duration = typeof _ === "function" ? _ : constant$1(_), tooltip) : duration;
  };
...
function value(d) {
  ...
  */
  tooltip.footer = function(_) {
    return arguments.length ? (footer = typeof _ === "function" ? _ : constant$1(_), tooltip) : footer;
  };
      ...
      @example <caption>default styles</caption>
{
  ...
  */
  tooltip.height = function(_) {
    return arguments.length ? (height = typeof _ === "function" ? _ : constant$1(_), tooltip) : height;
  };
...
function value(d, i) {
  ...
  */
  tooltip.id = function(_) {
    return arguments.length ? (id = typeof _ === "function" ? _ : constant$1(_), tooltip) : id;
  };
  ...
  */
  tooltip.offset = function(_) {
    return arguments.length ? (offset = typeof _ === "function" ? _ : constant$1(_), tooltip) : offset;
  };
  ...
  */
  tooltip.padding = function(_) {
    return arguments.length ? (padding = typeof _ === "function" ? _ : constant$1(_), tooltip) : padding;
  };
  ...
  */
  tooltip.pointerEvents = function(_) {
    return arguments.length ? (pointerEvents = typeof _ === "function" ? _ : constant$1(_), tooltip) : pointerEvents;
  };
...
function value(d) {
  ...
  */
  tooltip.title = function(_) {
    return arguments.length ? (title = typeof _ === "function" ? _ : constant$1(_), tooltip) : title;
  };
...
function value(d) {
  ...
  */
  tooltip.translate = function(_) {
    return arguments.length ? (translate = typeof _ === "function" ? _ : constant$1(_), tooltip) : translate;
  };
  ...
  */
  tooltip.width = function(_) {
    return arguments.length ? (width = typeof _ === "function" ? _ : constant$1(_), tooltip) : width;
  };
...
function value(d) {
  ...
  */
  Viz.prototype.groupBy = function groupBy (_) {
    ...
    return this._groupBy = _.map(function (k) { return typeof k === "function" ? k : accessor$1(k); }), this;
  };
  ...
  Treemap.prototype.render = function render (callback) {
    ...
    */
    ...
    this._shapes.push(new Rect()
      ...
      .select(elem("g.d3plus-Treemap", {parent: this._select, enter: {transform: transform}, update: {transform: transform}}).node())
...
function sum(d) {
  ...
  */
  Treemap.prototype.sum = function sum (_) {
    return arguments.length ? (this._sum = typeof _ === "function" ? _ : constant$1(_), this) : this._sum;
  };
...
//# sourceMappingURL=d3plus-treemap.full.js.map
