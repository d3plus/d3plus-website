...
var pi$5 = Math.PI;
var halfPi$2 = pi$5 / 2;
var quarterPi = pi$5 / 4;
var tau$3 = pi$5 * 2;

var degrees$1 = 180 / pi$5;
var radians = pi$5 / 180;
...
function rotationIdentity(lambda, phi) {
  return [lambda > pi$5 ? lambda - tau$3 : lambda < -pi$5 ? lambda + tau$3 : lambda, phi];
}
...
function forwardRotationLambda(deltaLambda) {
  return function(lambda, phi) {
    return lambda += deltaLambda, [lambda > pi$5 ? lambda - tau$3 : lambda < -pi$5 ? lambda + tau$3 : lambda, phi];
  };
}
...
function clipAntimeridianLine(stream) {
  ...
  return {
    ...
    point: function(lambda1, phi1) {
      ...
      if (abs$1(delta - pi$5) < epsilon$2) { // line crosses a pole
...
var clipCircle = function(radius, delta) {
  ...
  function intersect(a, b, two) {
    ...
    var delta = lambda1 - lambda0,
        polar = abs$1(delta - pi$5) < epsilon$2,
  ...
  return clip(visible, clipLine, interpolate, smallRadius ? [0, -radius] : [-pi$5, radius - pi$5]);
};
...
If *data* is not specified, this method returns the current Topojson *Object*, which by default is `undefined`.
  ...
  */
  Geomap.prototype.point = function point (_) {
    return arguments.length ? (this._point = typeof _ === "function" ? _ : constant$4(_), this) : this._point;
  };
  ...
  */
  Geomap.prototype.pointSize = function pointSize (_) {
    return arguments.length ? (this._pointSize = typeof _ === "function" ? _ : constant$4(_), this) : this._pointSize;
  };
...
function value(d) {
  ...
  */
  Pie.prototype.value = function value (_) {
    return arguments.length
         ? (this._value = typeof _ === "function" ? _ : constant$4(_), this)
         : this._value;
  };
  ...
  */
  Tree.prototype._draw = function _draw (callback) {
    ...
    */
    ...
    if (typeof r !== "function") { r = constant$4(r); }
...
var Treemap = (function (Viz$$1) {
  ...
  */
  Treemap.prototype.padding = function padding (_) {
    return arguments.length
         ? (this._padding = typeof _ === "function" ? _ : constant$4(_), this)
         : this._padding;
  };
...
function sum(d) {
  ...
  */
  Treemap.prototype.sum = function sum (_) {
    return arguments.length
         ? (this._sum = typeof _ === "function" ? _ : constant$4(_), this)
         : this._sum;
  };
  ...
  */
  Network.prototype._zoomToBounds = function _zoomToBounds (bounds) {
    ...
    if (bounds) {
      ...
      this._networkGroup.transition()
        .duration(this._zoomBehavior.duration())
        .call(this._zoomBehavior.transform, identity$7);
    ...
    var rMax = this._sizeMax || min(
          merge(nodes
            .map(function (n1) { return nodes
              .map(function (n2) { return n1 === n2 ? null : pointDistance([n1.x, n1.y], [n2.x, n2.y]); }); }
            )
          )
        ) / 2;
...
var Plot = (function (Viz$$1) {
  ...
  */
  Plot.prototype._draw = function _draw (callback) {
    ...
    var yGroup = elem("g.d3plus-plot-y-axis", {parent: parent, transition: transition, enter: {transform: transform}, update: {transform: transform}});
