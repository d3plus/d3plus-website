...
var TextBox$1 = (function (BaseClass) {
  ...
  */
  TextBox.prototype.render = function render (callback) {
    ...
    if (this._select === void 0) this.select(d3$3.select("body").append("svg").style("width", ((window.innerWidth) + "px")).style("height", ((window.innerHeight) + "px")).node());
    if (this._lineHeight === void 0) this._lineHeight = function (d, i) { return this$1._fontSize(d, i) * 1.1; };
    var that = this;
    ...
    this._shapeConfig = {
      ...
      x: function (d, i) {
        ...
        if (this$1._orient === "vertical") return this$1._outerBounds.x + s(d, i) / 2;
          ...
          return this$1._outerBounds.x + d3Sum(this$1._data.slice(0, i).map(function (b, i) { return s(b, i); })) +
                 d3Sum(this$1._lineData.slice(0, i).map(function (l) { return l.width - this$1._shapeConfig.fontSize(d, i); })) +
                 s(d, i) / 2 + this$1._padding * 3 * i;
        }
      },
      y: function (d, i) {
        var s = this$1._shapeConfig.height;
        if (this$1._orient === "horizontal") return this$1._titleHeight + this$1._outerBounds.y + d3Max(this$1._lineData.map(function (l) { return l.height; }).concat(this$1._data.map(function (l, x) { return s(l, x); }))) / 2;
        else {
          var h = s(d, i);
          var pad = this$1._lineData[i].height > h ? this$1._lineData[i].height / 2 : h / 2,
                prev = d3Sum(this$1._lineData.slice(0, i), function (l, x) { return d3Max([l.height, s(l.data, x)]); });
  ...
  */
  Legend.prototype.render = function render (callback) {
    ...
    if (this._title) {
      ...
      var res = wrap$1().fontFamily(f).fontSize(s).lineHeight(lH).width(this._width).height(this._height)(this._title);
    ...
    this._lineData = this._data.map(function (d, i) {
      ...
      var res = wrap$1().fontFamily(f).fontSize(s).lineHeight(lh).width(w).height(h)(this$1._label(d, i));
    ...
    if (this._orient === "horizontal") {
      availableSpace = this._width - d3Sum(this._data.map(function (d, i) { return this$1._shapeConfig.width(d, i) + this$1._padding * 3; })) - this._padding * 2;
      textSpace = d3Sum(this._lineData.map(function (d, i) { return d.width - this$1._shapeConfig.fontSize(d, i); }));
        ...
        if (wrappable.length && availableHeight > wrappable[0].height * 2) {
          ...
          while (line <= 5) {
            ...
            var loop = function ( x ) {
              ...
              var res$1 = wrap$1().fontFamily(label.f).fontSize(label.s).lineHeight(label.lh).width(w).height(h)(label.sentence);
              if (!res$1.truncated) {
                textSpace -= label.width;
                label.width = Math.ceil(d3Max(res$1.lines.map(function (t) { return measure$1(t, {"font-family": label.f, "font-size": label.s}); }))) + label.s;
      ...
      availableSpace = this._width - d3Max(this._data.map(function (d, i) { return this$1._shapeConfig.width(d, i) + this$1._padding * 3; })) - this._padding * 2;
      textSpace = d3Max(this._lineData.map(function (d, i) { return d.width - this$1._shapeConfig.fontSize(d, i); }));
    }
    ...
    var innerHeight = d3Max(this._lineData, function (d, i) { return d3Max([d.height, this$1._shapeConfig.height(d.data, i)]); }) + this._titleHeight,
          innerWidth = this._orient === "horizontal"
                     ? textSpace + d3Sum(this._data, function (d, i) { return this$1._shapeConfig.width(d, i); }) + this._padding * (this._data.length * (visibleLabels ? 3 : 1) - 2)
                     : textSpace + d3Max(this._data, function (d, i) { return this$1._shapeConfig.width(d, i); }) + this._padding * 3;
