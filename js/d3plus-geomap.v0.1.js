...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-array'), require('d3-geo'), require('d3-scale'), require('d3-selection'), require('d3-tile'), require('d3-zoom'), require('world-atlas/world/110m.json'), require('topojson-client'), require('d3plus-common'), require('d3plus-shape'), require('d3plus-viz')) :
  typeof define === 'function' && define.amd ? define('d3plus-geomap', ['exports', 'd3-array', 'd3-geo', 'd3-scale', 'd3-selection', 'd3-tile', 'd3-zoom', 'world-atlas/world/110m.json', 'topojson-client', 'd3plus-common', 'd3plus-shape', 'd3plus-viz'], factory) :
  (factory((global.d3plus = global.d3plus || {}),global.d3Array,global.d3Geo,global.scales,global.d3Selection,global.d3Tile,global.d3Zoom,global.topo,global.topojsonClient,global.d3plusCommon,global.d3plusShape,global.d3plusViz));
}(this, (function (exports,d3Array,d3Geo,scales,d3Selection,d3Tile,d3Zoom,topo,topojsonClient,d3plusCommon,d3plusShape,d3plusViz) { 'use strict';

topo = 'default' in topo ? topo['default'] : topo;
