...
(function (global, factory) {
  ...
  */
  ...
  var windowsLocale = /*#__PURE__*/Object.freeze({
    aa: aa,
    af: af,
    agq: agq,
    ak: ak,
  ...
  var iso639Codes = /*#__PURE__*/Object.freeze({
    Abkhazian: Abkhazian,
    Achinese: Achinese,
    Acoli: Acoli,
    Adangme: Adangme,
  ...
  var lcid = getCjsExportFromNamespace(windowsLocale);

  var iso = getCjsExportFromNamespace(iso639Codes);

  var all = [];
  var lcidLanguage;
  var isoLanguage;
  var lcidKeys = Object.keys(lcid);
  var isoKeys = Object.keys(iso);
  lcidKeys.map(function (id) {
    lcidLanguage = id;
    isoLanguage = isoKeys.find(function (name) {
      return name.toLowerCase() == lcid[lcidLanguage].language.toLowerCase();
    });

    if (!isoLanguage) {
      var _all$push;

      all.push((_all$push = {}, _defineProperty(_all$push, 'name', lcid[lcidLanguage]['language']), _defineProperty(_all$push, 'location', lcid[lcidLanguage]['location']), _defineProperty(_all$push, 'tag', lcid[lcidLanguage]['tag']), _defineProperty(_all$push, 'lcid', lcid[lcidLanguage]['id']), _defineProperty(_all$push, 'iso639-2', null), _defineProperty(_all$push, 'iso639-1', null), _all$push));
    } else {
      var _all$push2;

      all.push((_all$push2 = {}, _defineProperty(_all$push2, 'name', lcid[lcidLanguage]['language']), _defineProperty(_all$push2, 'location', lcid[lcidLanguage]['location']), _defineProperty(_all$push2, 'tag', lcid[lcidLanguage]['tag']), _defineProperty(_all$push2, 'lcid', lcid[lcidLanguage]['id']), _defineProperty(_all$push2, 'iso639-2', iso[isoLanguage]['iso639-2']), _defineProperty(_all$push2, 'iso639-1', iso[isoLanguage]['iso639-1']), _all$push2));
    }
  });
  ...
  var getByName = function getByName(text) {
    return where('name', text);
  };

  var getByLocation = function getByLocation(text) {
    return where('location', text);
  };

  var getByTag = function getByTag(text) {
    return where('tag', text);
  };

  var getByLCID = function getByLCID(id) {
    return where('lcid', Number(id));
  };

  var getByISO6392 = function getByISO6392(text) {
    return where('iso639-2', text);
  };

  var getByISO6391 = function getByISO6391(text) {
    return where('iso639-1', text);
  };
  ...
  var localeCodes = {
    ...
    getByTag: getByTag,
    getByLCID: getByLCID,
    getByISO6392: getByISO6392,
    getByISO6391: getByISO6391
  };
  var localeCodes_1 = localeCodes.all;

  var locales = localeCodes_1.filter(function (d) {
