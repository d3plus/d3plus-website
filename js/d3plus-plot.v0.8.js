  ...
  */
  var BoxWhisker = (function (Plot$$1) {
    function BoxWhisker() {
      ...
      Plot$$1.call(this);
      this._discrete = "x";
      this._shape = d3plusCommon.constant("Box");
      this.x("x");
  ...
  var Radar = (function (Viz) {
    ...
    */
    Radar.prototype._draw = function _draw (callback) {
      ...
      var maxValue = d3Array.max(nestedGroupData.map(function (h) { return h.values.map(function (d) { return d3Array.sum(d.values, function (x, i) { return this$1._value(x, i); }); }); }).flat());
