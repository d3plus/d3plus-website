      ...
      if (w > fMin && (h > lH || resize && h > fMin * 1.1)) {
        ...
        if (resize) {
          ...
          if (maxWidth > w || textArea > boxArea) {
            ...
            var sizeRatio = d3Min([areaRatio, widthRatio]);
...
var Axis = (function (BaseClass) {
  function Axis() {
    ...
    this._tickScale = scaleSqrt().domain([10, 400]).range([10, 50]);
    this._tickSize = 5;
    this._titleConfig = {
      fontFamily: "Verdana",
      fontSize: 12,
...
{"width": 180, "height": 24, "x": 10, "y": 20}
  ...
  */
  Axis.prototype.render = function render (callback) {
    ...
    var maxTextHeight = max(textData, function (t) { return t.height; }) || 0;
...
var combiningMarks$1 = a$1.concat(b$1);
...
/**
    ...
    @param {String} sentence
*/
function defaultSplit$1(sentence) {
...
function textBox(data) {
  ...
  */
  function textBox(callback) {
    ...
    if (select === void 0) textBox.select(d3$1.select("body").append("svg").style("width", ((window.innerWidth) + "px")).style("height", ((window.innerHeight) + "px")).node());
...
function(d, i) {
  ...
  */
  textBox.select = function(_) {
    return arguments.length ? (select = d3$1.select(_), textBox) : select;
  };
...
var Shape = function Shape() {
  ...
  this._backgroundImage = constant$3(false);
  this._data = [];
  this._duration = 600;
  this._fill = constant$3("black");
...
Shape.prototype.labelPadding = function labelPadding (_) {
  return arguments.length ? (this._labelPadding = typeof _ === "function" ? _ : constant$3(_), this) : this._labelPadding;
};
...
function symbol() {
  var type = constant$5(symbolCircle),
      size = constant$5(64),
      context = null;
...
function stack() {
  ...
  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? stackOrderNone : typeof _ === "function" ? _ : constant$5(slice$2.call(_)), stack) : order;
  };
...
Image$1.prototype.render = function render (callback) {
  ...
  if (this._select === void 0) this.select(d3$4.select("body").append("svg").style("width", ((window.innerWidth) + "px")).style("height", ((window.innerHeight) + "px")).style("display", "block").node());
  ...
  var t = d3$4.transition().duration(this._duration),
        that = this,
        update = enter.merge(images);
  ...
  update
    ...
    .transition(t)
      ...
      .attr("y", function (d, i) { return this$1._y(d, i); })
      .each(function(d, i) {
        var image = d3$4.select(this), link = that._url(d, i);
        var fullAddress = link.indexOf("http://") === 0 || link.indexOf("https://") === 0;
        if (!fullAddress || link.indexOf(window.location.hostname) === 0) {
          var img = new Image$1();
          img.src = link;
...
/**
    ...
    @param {String|HTMLElement} [*selector* = d3.select("body").append("svg")]
*/
Image$1.prototype.select = function select (_) {
  return arguments.length ? (this._select = d3$4.select(_), this) : this._select;
};
...
Shape$1.prototype.render = function render (callback) {
  ...
  if (this._select === void 0) this.select(d3$3.select("body").append("svg").style("width", ((window.innerWidth) + "px")).style("height", ((window.innerHeight) + "px")).style("display", "block").node());
  if (this._lineHeight === void 0) this.lineHeight(function (d, i) { return this$1._fontSize(d, i) * 1.1; });

  this._transition = d3$3.transition().duration(this._duration);
...
/**
    ...
    @param {String|HTMLElement} [*selector* = d3.select("body").append("svg")]
*/
Shape$1.prototype.select = function select (_) {
  return arguments.length ? (this._select = d3$3.select(_), this) : this._select;
};
...
var Legend = (function (BaseClass) {
    ...
    this._shapeConfig = {
      ...
      x: function (d, i) {
        ...
        if (this$1._orient === "vertical") return this$1._outerBounds.x + s(d, i) / 2;
          ...
          return this$1._outerBounds.x + sum(this$1._data.slice(0, i).map(function (b, i) { return s(b, i); })) +
                 sum(this$1._lineData.slice(0, i).map(function (l) { return l.width - this$1._shapeConfig.fontSize(d, i); })) +
                 s(d, i) / 2 + this$1._padding * 3 * i;
        }
      },
      y: function (d, i) {
        var s = this$1._shapeConfig.height;
        if (this$1._orient === "horizontal") return this$1._titleHeight + this$1._outerBounds.y + max(this$1._lineData.map(function (l) { return l.height; }).concat(this$1._data.map(function (l, x) { return s(l, x); }))) / 2;
        else {
          var h = s(d, i);
          var pad = this$1._lineData[i].height > h ? this$1._lineData[i].height / 2 : h / 2,
                prev = sum(this$1._lineData.slice(0, i), function (l, x) { return max([l.height, s(l.data, x)]); });
  ...
  */
  Legend.prototype.render = function render (callback) {
    ...
    // Shape <g> Group
    var shapeGroup = elem("g.d3plus-Legend", {parent: this._select});
    ...
    if (this._orient === "horizontal") {
      availableSpace = this._width - sum(this._data.map(function (d, i) { return this$1._shapeConfig.width(d, i) + this$1._padding * 3; })) - this._padding * 2;
      textSpace = sum(this._lineData.map(function (d, i) { return d.width - this$1._shapeConfig.fontSize(d, i); }));
        ...
        if (wrappable.length && availableHeight > wrappable[0].height * 2) {
          ...
          while (line <= 5) {
            ...
            var loop = function ( x ) {
              ...
              var res$1 = textWrap().fontFamily(label.f).fontSize(label.s).lineHeight(label.lh).width(w).height(h)(label.sentence);
              if (!res$1.truncated) {
                textSpace -= label.width;
                label.width = Math.ceil(max(res$1.lines.map(function (t) { return textWidth(t, {"font-family": label.f, "font-size": label.s}); }))) + label.s;
      ...
      availableSpace = this._width - max(this._data.map(function (d, i) { return this$1._shapeConfig.width(d, i) + this$1._padding * 3; })) - this._padding * 2;
      textSpace = max(this._lineData.map(function (d, i) { return d.width - this$1._shapeConfig.fontSize(d, i); }));
    }
    ...
    var innerHeight = max(this._lineData, function (d, i) { return max([d.height, this$1._shapeConfig.height(d.data, i)]); }) + this._titleHeight,
          innerWidth = this._orient === "horizontal"
                     ? textSpace + sum(this._data, function (d, i) { return this$1._shapeConfig.width(d, i); }) + this._padding * (this._data.length * (visibleLabels ? 3 : 1) - 2)
                     : textSpace + max(this._data, function (d, i) { return this$1._shapeConfig.width(d, i); }) + this._padding * 3;
    ...
    // Legend Shapes
    nest().key(function (d) { return d.shape; }).entries(shapeData).forEach(function (d) {
...
function tooltip(data) {
  ...
  function boxStyles(box) {
    box
      ...
      .style("border", function(d, i) {
        var b = d3$5.select(this).style("border");
  ...
  */
  function cellContent(d) {
    if (typeof d === "function") {
      var datum = d3$5.select(this.parentNode.parentNode).datum();
  ...
  var background = constant$3("rgba(255, 255, 255, 0.75)"),
      body = accessor("body", ""),
      bodyStyle = {
        "font-family": "Verdana",
        "font-size": "10px",
      ...
      border = constant$3("1px solid rgba(0, 0, 0, 0.1)"),
      borderRadius = constant$3("2px"),
      className = "d3plus-tooltip",
      duration = constant$3(200),
      ...
      height = constant$3("auto"),
      id = tooltipId,
      offset = constant$3(10),
      padding = constant$3("5px"),
      pointerEvents = constant$3("auto"),
      tableStyle = {
        "border-spacing": "0",
        "width": "100%"
      },
  ...
  */
  function tooltip(callback) {
    ...
    var tooltips = d3$5.select("body").selectAll(("." + className))
      .data(data, id);
  ...
  */
  tooltip.background = function(_) {
    return arguments.length ? (background = typeof _ === "function" ? _ : constant$3(_), tooltip) : background;
  };
...
function value(d) {
  ...
  */
  tooltip.body = function(_) {
    return arguments.length ? (body = typeof _ === "function" ? _ : constant$3(_), tooltip) : body;
  };
      ...
      @example <caption>default styles</caption>
{
  ...
  */
  tooltip.border = function(_) {
    return arguments.length ? (border = typeof _ === "function" ? _ : constant$3(_), tooltip) : border;
  };
  ...
  */
  tooltip.borderRadius = function(_) {
    return arguments.length ? (borderRadius = typeof _ === "function" ? _ : constant$3(_), tooltip) : borderRadius;
  };
  ...
  */
  tooltip.duration = function(_) {
    return arguments.length ? (duration = typeof _ === "function" ? _ : constant$3(_), tooltip) : duration;
  };
...
function value(d) {
  ...
  */
  tooltip.footer = function(_) {
    return arguments.length ? (footer = typeof _ === "function" ? _ : constant$3(_), tooltip) : footer;
  };
      ...
      @example <caption>default styles</caption>
{
  ...
  */
  tooltip.height = function(_) {
    return arguments.length ? (height = typeof _ === "function" ? _ : constant$3(_), tooltip) : height;
  };
...
function value(d, i) {
  ...
  */
  tooltip.id = function(_) {
    return arguments.length ? (id = typeof _ === "function" ? _ : constant$3(_), tooltip) : id;
  };
  ...
  */
  tooltip.offset = function(_) {
    return arguments.length ? (offset = typeof _ === "function" ? _ : constant$3(_), tooltip) : offset;
  };
  ...
  */
  tooltip.padding = function(_) {
    return arguments.length ? (padding = typeof _ === "function" ? _ : constant$3(_), tooltip) : padding;
  };
  ...
  */
  tooltip.pointerEvents = function(_) {
    return arguments.length ? (pointerEvents = typeof _ === "function" ? _ : constant$3(_), tooltip) : pointerEvents;
  };
...
function value(d) {
  ...
  */
  tooltip.title = function(_) {
    return arguments.length ? (title = typeof _ === "function" ? _ : constant$3(_), tooltip) : title;
  };
...
function value(d) {
  ...
  */
  tooltip.translate = function(_) {
    return arguments.length ? (translate = typeof _ === "function" ? _ : constant$3(_), tooltip) : translate;
  };
  ...
  */
  tooltip.width = function(_) {
    return arguments.length ? (width = typeof _ === "function" ? _ : constant$3(_), tooltip) : width;
  };
...
var Plot = (function (Viz) {
  ...
  */
  Plot.prototype.render = function render (callback) {
    ...
    var x = linear().domain(extent(data, function (d) { return d.x; })).range([0, width]),
        y = linear().domain(extent(data, function (d) { return d.y; }).reverse()).range([0, height]);
