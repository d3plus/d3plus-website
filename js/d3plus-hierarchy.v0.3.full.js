...
var I18n$1 = function (_EventEmitter) {
  ...
  I18n.prototype.loadResources = function loadResources() {
    ...
    var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : noop$3;
  ...
  I18n.prototype.cloneInstance = function cloneInstance() {
    ...
    var mergedOptions = _extends$6({}, options, this.options, { isClone: true });
...
var Back$2 = "Back";
var Total$2 = "Total";
var array$4 = {"lowercase":["a","an","and","as","at","but","by","for","from","if","in","into","near","nor","of","on","onto","or","per","that","the","to","with","via","vs","vs."],"uppercase":["CEO","CFO","CNC","COO","CPU","GDP","HVAC","ID","IT","R&D","TV","UI"]};
var enUS$1 = {
	Back: Back$2,
	Total: Total$2,
	array: array$4
...
var Back$3 = "Atrás";
var Total$3 = "Total";
var array$5 = {"lowercase":["una","y","en","pero","en","de","o","el","la","los","las","para","a","con"],"uppercase":["CEO","CFO","CNC","COO","CPU","PIB","HVAC","ID","TI","I&D","TV","UI"]};
var esES$1 = {
	Back: Back$3,
	Total: Total$3,
	array: array$5
...
function defaultLocale(definition) {
  locale$3 = formatLocale(definition);
  format = locale$3.format;
...
function log() {
  ...
  scale.copy = function() {
    return copy$2(scale, log().base(base));
  };
...
function pow() {
  ...
  scale.copy = function() {
    return copy$2(scale, pow().exponent(exponent));
  };
...
function defaultLocale$1(definition) {
  locale$4 = formatLocale$1(definition);
  timeFormat = locale$4.format;
  timeParse = locale$4.parse;
  utcFormat = locale$4.utcFormat;
  utcParse = locale$4.utcParse;
  return locale$4;
}
...
function calendar(year$$1, month$$1, week, day$$1, hour$$1, minute$$1, second$$1, millisecond$$1, format) {
  ...
  scale.copy = function() {
    return copy$2(scale, calendar(year$$1, month$$1, week, day$$1, hour$$1, minute$$1, second$$1, millisecond$$1, format));
  };
...
var checked = {};
var height = 32;
var macos = textWidth(alpha, {"font-family": "-apple-system", "font-size": height});
var monospace = textWidth(alpha, {"font-family": "monospace", "font-size": height});
var proportional = textWidth(alpha, {"font-family": "sans-serif", "font-size": height});
var ubuntu = textWidth(alpha, {"font-family": "Ubuntu", "font-size": height});
  ...
  var loop = function ( i ) {
    ...
    Object.keys(source).forEach(function (prop) {
      ...
      if (isObject$2(value)) {
        ...
        if (target.hasOwnProperty(prop) && isObject$2(target[prop])) { target[prop] = assign$4(target[prop], value); }
        else { target[prop] = value; }
        ...
        if (target.hasOwnProperty(prop) && Array.isArray(target[prop])) {
          ...
          value.forEach(function (sourceItem, itemIndex) {
            ...
            if (itemIndex < targetArray.length) {
              ...
              if (isObject$2(targetItem) && isObject$2(sourceItem) || Array.isArray(targetItem) && Array.isArray(sourceItem)) {
                targetArray[itemIndex] = assign$4(targetItem, sourceItem);
              }
              else { targetArray[itemIndex] = sourceItem; }
...
/**
    ...
    @desc An abstract class that contains some global methods and functionality.
*/
var BaseClass$4 = function BaseClass() {
  this._on = {};
...
var Logger$2 = function () {
  function Logger(concreteLogger) {
    ...
    _classCallCheck$21(this, Logger);
  ...
  Logger.prototype.init = function init(concreteLogger) {
    ...
    this.prefix = options.prefix || 'i18next:';
    this.logger = concreteLogger || consoleLogger$2;
    this.options = options;
    this.debug = options.debug === false ? false : true;
  };
  ...
  Logger.prototype.create = function create(moduleName) {
    var sub = new Logger(this.logger, _extends$13({ prefix: this.prefix + ':' + moduleName + ':' }, this.options));
...
var EventEmitter$4 = function () {
	function EventEmitter() {
		_classCallCheck$22(this, EventEmitter);
...
function deepExtend$2(target, source, overwrite) {
  for (var prop in source) {
    if (prop in target) {
      // If we reached a leaf string in target or source then replace with source or skip depending on the 'overwrite' switch
      if (typeof target[prop] === 'string' || target[prop] instanceof String || typeof source[prop] === 'string' || source[prop] instanceof String) {
        ...
        deepExtend$2(target[prop], source[prop], overwrite);
      }
    } else {
      target[prop] = source[prop];
    }
...
var ResourceStore$4 = function (_EventEmitter) {
  _inherits$11(ResourceStore, _EventEmitter);

  function ResourceStore() {
    var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { ns: ['translation'], defaultNS: 'translation' };

    _classCallCheck$23(this, ResourceStore);

    var _this = _possibleConstructorReturn$11(this, _EventEmitter.call(this));
  ...
  ResourceStore.prototype.addResourceBundle = function addResourceBundle(lng, ns, resources, deep, overwrite) {
    ...
    if (deep) {
      deepExtend$2(pack, resources, overwrite);
    } else {
      pack = _extends$14({}, pack, resources);
    }
  ...
  ResourceStore.prototype.getResourceBundle = function getResourceBundle(lng, ns) {
    ...
    // TODO: COMPATIBILITY remove extend in v2.1.0
    if (this.options.compatibilityAPI === 'v1') { return _extends$14({}, this.getResource(lng, ns)); }
...
function convertInterpolation$2(options) {
...
function convertAPIOptions$2(options) {
  if (options.resStore) { options.resources = options.resStore; }
  ...
  options = convertInterpolation$2(options);
  if (options.defaultVariables) { options.interpolation.defaultVariables = options.defaultVariables; }
...
function convertJSONOptions$2(options) {
  options = convertInterpolation$2(options);
  options.joinArrays = '\n';
...
function convertTOptions$2(options) {
  if (options.interpolationPrefix || options.interpolationSuffix || options.escapeInterpolation) {
    options = convertInterpolation$2(options);
  }
...
function appendBackwardsAPI$2(i18n) {
  i18n.lng = function () {
    baseLogger$2.deprecate('i18next.lng() can be replaced by i18next.language for detected language or i18next.languages for languages ordered by translation lookup.');
    return i18n.services.languageUtils.toResolveHierarchy(i18n.language)[0];
  };

  i18n.preload = function (lngs, cb) {
    baseLogger$2.deprecate('i18next.preload() can be replaced with i18next.loadLanguages()');
    i18n.loadLanguages(lngs, cb);
  };

  i18n.setLng = function (lng, options, callback) {
    baseLogger$2.deprecate('i18next.setLng() can be replaced with i18next.changeLanguage() or i18next.getFixedT() to get a translation function with fixed language or namespace.');
    if (typeof options === 'function') {
      callback = options;
      options = {};
    }
  ...
  i18n.addPostProcessor = function (name, fc) {
    baseLogger$2.deprecate('i18next.addPostProcessor() can be replaced by i18next.use({ type: \'postProcessor\', name: \'name\', process: fc })');
    i18n.use({
      type: 'postProcessor',
      name: name,
      process: fc
...
var Translator$4 = function (_EventEmitter) {
  _inherits$12(Translator, _EventEmitter);

  function Translator(services) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck$24(this, Translator);

    var _this = _possibleConstructorReturn$12(this, _EventEmitter.call(this));

    copy$3(['resourceStore', 'languageUtils', 'pluralResolver', 'interpolator', 'backendConnector'], services, _this);

    _this.options = options;
    _this.logger = baseLogger$2.create('translator');
    return _this;
  }
  ...
  Translator.prototype.exists = function exists(key) {
    ...
    if (this.options.compatibilityAPI === 'v1') {
      options = convertTOptions$2(options);
    }
  ...
  Translator.prototype.translate = function translate(keys) {
    ...
    if ((typeof options === 'undefined' ? 'undefined' : _typeof$7(options)) !== 'object') {
      options = this.options.overloadTranslationOptionHandler(arguments);
    } else if (this.options.compatibilityAPI === 'v1') {
      options = convertTOptions$2(options);
    }
    ...
    if (res && typeof res !== 'string' && noObject.indexOf(resType) < 0 && !(joinArrays && resType === '[object Array]')) {
      ...
      for (var m in res) {
        copy$$1[m] = this$1.translate('' + key + keySeparator + m, _extends$15({ joinArrays: false, ns: namespaces }, options));
      }
      res = copy$$1;
    }
    // array special treatment
  ...
  Translator.prototype.extendTranslation = function extendTranslation(res, key, options) {
    ...
    if (options.interpolation) { this.interpolator.init(_extends$15({}, options, { interpolation: _extends$15({}, this.options.interpolation, options.interpolation) })); }

    // interpolate
    var data = options.replace && typeof options.replace !== 'string' ? options.replace : options;
    if (this.options.interpolation.defaultVariables) { data = _extends$15({}, this.options.interpolation.defaultVariables, data); }
    res = this.interpolator.interpolate(res, data, this.language);
    ...
    if (res !== undefined && postProcessorNames && postProcessorNames.length && options.applyPostProcessor !== false) {
      res = postProcessor$2.handle(postProcessorNames, res, key, options, this);
    }
...
var LanguageUtil$2 = function () {
  function LanguageUtil(options) {
    _classCallCheck$25(this, LanguageUtil);

    this.options = options;

    this.whitelist = this.options.whitelist || false;
    this.logger = baseLogger$2.create('languageUtils');
  }
...
// definition http://translate.sourceforge.net/wiki/l10n/pluralforms
/* eslint-disable */
var sets$2 = [{ lngs: ['ach', 'ak', 'am', 'arn', 'br', 'fil', 'gun', 'ln', 'mfe', 'mg', 'mi', 'oc', 'tg', 'ti', 'tr', 'uz', 'wa'], nr: [1, 2], fc: 1 }, { lngs: ['af', 'an', 'ast', 'az', 'bg', 'bn', 'ca', 'da', 'de', 'dev', 'el', 'en', 'eo', 'es', 'es_ar', 'et', 'eu', 'fi', 'fo', 'fur', 'fy', 'gl', 'gu', 'ha', 'he', 'hi', 'hu', 'hy', 'ia', 'it', 'kn', 'ku', 'lb', 'mai', 'ml', 'mn', 'mr', 'nah', 'nap', 'nb', 'ne', 'nl', 'nn', 'no', 'nso', 'pa', 'pap', 'pms', 'ps', 'pt', 'pt_br', 'rm', 'sco', 'se', 'si', 'so', 'son', 'sq', 'sv', 'sw', 'ta', 'te', 'tk', 'ur', 'yo'], nr: [1, 2], fc: 2 }, { lngs: ['ay', 'bo', 'cgg', 'fa', 'id', 'ja', 'jbo', 'ka', 'kk', 'km', 'ko', 'ky', 'lo', 'ms', 'sah', 'su', 'th', 'tt', 'ug', 'vi', 'wo', 'zh'], nr: [1], fc: 3 }, { lngs: ['be', 'bs', 'dz', 'hr', 'ru', 'sr', 'uk'], nr: [1, 2, 5], fc: 4 }, { lngs: ['ar'], nr: [0, 1, 2, 3, 11, 100], fc: 5 }, { lngs: ['cs', 'sk'], nr: [1, 2, 5], fc: 6 }, { lngs: ['csb', 'pl'], nr: [1, 2, 5], fc: 7 }, { lngs: ['cy'], nr: [1, 2, 3, 8], fc: 8 }, { lngs: ['fr'], nr: [1, 2], fc: 9 }, { lngs: ['ga'], nr: [1, 2, 3, 7, 11], fc: 10 }, { lngs: ['gd'], nr: [1, 2, 3, 20], fc: 11 }, { lngs: ['is'], nr: [1, 2], fc: 12 }, { lngs: ['jv'], nr: [0, 1], fc: 13 }, { lngs: ['kw'], nr: [1, 2, 3, 4], fc: 14 }, { lngs: ['lt'], nr: [1, 2, 10], fc: 15 }, { lngs: ['lv'], nr: [1, 2, 0], fc: 16 }, { lngs: ['mk'], nr: [1, 2], fc: 17 }, { lngs: ['mnk'], nr: [0, 1, 2], fc: 18 }, { lngs: ['mt'], nr: [1, 2, 11, 20], fc: 19 }, { lngs: ['or'], nr: [2, 1], fc: 2 }, { lngs: ['ro'], nr: [1, 2, 20], fc: 20 }, { lngs: ['sl'], nr: [5, 1, 2, 3], fc: 21 }];

var _rulesPluralsTypes$2 = {
  1: function _(n) {
    return Number(n > 1);
  },
  2: function _(n) {
...
function createRules$2() {
  var l,
      rules = {};
  sets$2.forEach(function (set) {
    set.lngs.forEach(function (l) {
      return rules[l] = {
        numbers: set.nr,
        plurals: _rulesPluralsTypes$2[set.fc]
      };
    });
  });
  return rules;
...
var PluralResolver$4 = function () {
  function PluralResolver(languageUtils) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck$26(this, PluralResolver);

    this.languageUtils = languageUtils;
    this.options = options;

    this.logger = baseLogger$2.create('pluralResolver');

    this.rules = createRules$2();
  }
...
var Interpolator$4 = function () {
  function Interpolator() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck$27(this, Interpolator);

    this.logger = baseLogger$2.create('interpolator');
  ...
  Interpolator.prototype.init = function init() {
    ...
    if (reset) {
      ...
      this.escape = options.interpolation && options.interpolation.escape || escape$2;
    }
    if (!options.interpolation) { options.interpolation = { escapeValue: true }; }
    ...
    this.prefix = iOpts.prefix ? regexEscape$2(iOpts.prefix) : iOpts.prefixEscaped || '{{';
    this.suffix = iOpts.suffix ? regexEscape$2(iOpts.suffix) : iOpts.suffixEscaped || '}}';
    this.formatSeparator = iOpts.formatSeparator ? regexEscape$2(iOpts.formatSeparator) : iOpts.formatSeparator || ',';

    this.unescapePrefix = iOpts.unescapeSuffix ? '' : iOpts.unescapePrefix || '-';
    this.unescapeSuffix = this.unescapePrefix ? '' : iOpts.unescapeSuffix || '';

    this.nestingPrefix = iOpts.nestingPrefix ? regexEscape$2(iOpts.nestingPrefix) : iOpts.nestingPrefixEscaped || regexEscape$2('$t(');
    this.nestingSuffix = iOpts.nestingSuffix ? regexEscape$2(iOpts.nestingSuffix) : iOpts.nestingSuffixEscaped || regexEscape$2(')');
  ...
  Interpolator.prototype.interpolate = function interpolate(str, data, lng) {
    ...
    var handleFormat = function handleFormat(key) {
      if (key.indexOf(_this.formatSeparator) < 0) { return getPath$2(data, key); }

      var p = key.split(_this.formatSeparator);
      var k = p.shift().trim();
      var f = p.join(_this.formatSeparator).trim();

      return _this.format(getPath$2(data, k), f, lng);
    };
    ...
    while (match = this.regexp.exec(str)) {
      value = handleFormat(match[1].trim());
      if (typeof value !== 'string') { value = makeString$2(value); }
      if (!value) {
        this$1.logger.warn('missed to pass in variable ' + match[1] + ' for interpolating ' + str);
        value = '';
      }
...
var Connector$4 = function (_EventEmitter) {
  _inherits$13(Connector, _EventEmitter);

  function Connector(backend, store, services) {
    var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

    _classCallCheck$28(this, Connector);

    var _this = _possibleConstructorReturn$13(this, _EventEmitter.call(this));

    _this.backend = backend;
    _this.store = store;
    _this.services = services;
    _this.options = options;
    _this.logger = baseLogger$2.create('backendConnector');
  ...
  Connector.prototype.loaded = function loaded(name, err, data) {
    ...
    var _name$split = name.split('|'),
        _name$split2 = _slicedToArray$2(_name$split, 2),
        lng = _name$split2[0],
        ns = _name$split2[1];
  ...
  Connector.prototype.load = function load(languages, namespaces, callback) {
    ...
    var options = _extends$16({}, this.backend.options, this.options.backend);
    ...
    if (options.allowMultiLoading && this.backend.readMulti) {
      this.read(toLoad.toLoadLanguages, toLoad.toLoadNamespaces, 'readMulti', null, null, function (err, data) {
        ...
        toLoad.toLoad.forEach(function (name) {
          var _name$split3 = name.split('|'),
              _name$split4 = _slicedToArray$2(_name$split3, 2),
              l = _name$split4[0],
              n = _name$split4[1];
    ...
    // load one by one
        ...
        (function () {
          var readOne = function readOne(name) {
            ...
            var _name$split5 = name.split('|'),
                _name$split6 = _slicedToArray$2(_name$split5, 2),
                lng = _name$split6[0],
                ns = _name$split6[1];
    ...
    // load one by one
        ...
        (function () {
          var readOne = function readOne(name) {
            ...
            var _name$split7 = name.split('|'),
                _name$split8 = _slicedToArray$2(_name$split7, 2),
                lng = _name$split8[0],
                ns = _name$split8[1];
...
var Connector$5 = function (_EventEmitter) {
  _inherits$14(Connector, _EventEmitter);

  function Connector(cache, store, services) {
    var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

    _classCallCheck$29(this, Connector);

    var _this = _possibleConstructorReturn$14(this, _EventEmitter.call(this));

    _this.cache = cache;
    _this.store = store;
    _this.services = services;
    _this.options = options;
    _this.logger = baseLogger$2.create('cacheConnector');
  ...
  Connector.prototype.load = function load(languages, namespaces, callback) {
    ...
    if (!this.cache) { return callback && callback(); }
    var options = _extends$17({}, this.cache.options, this.options.cache);
...
function transformOptions$2(options) {
  // create namespace object if namespace is passed in as string
  if (typeof options.ns === 'string') { options.ns = [options.ns]; }
  if (typeof options.fallbackLng === 'string') { options.fallbackLng = [options.fallbackLng]; }
  if (typeof options.fallbackNS === 'string') { options.fallbackNS = [options.fallbackNS]; }
...
var I18n$2 = function (_EventEmitter) {
  _inherits$10(I18n, _EventEmitter);

  function I18n() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var callback = arguments[1];

    _classCallCheck$20(this, I18n);

    var _this = _possibleConstructorReturn$10(this, _EventEmitter.call(this));

    _this.options = transformOptions$2(options);
    _this.services = {};
    _this.logger = baseLogger$2;
    _this.modules = {};
  ...
  I18n.prototype.init = function init(options, callback) {
    ...
    if (options.compatibilityAPI === 'v1') {
      this.options = _extends$12({}, get$4(), transformOptions$2(convertAPIOptions$2(options)), {});
    } else if (options.compatibilityJSON === 'v1') {
      this.options = _extends$12({}, get$4(), transformOptions$2(convertJSONOptions$2(options)), {});
    } else {
      this.options = _extends$12({}, get$4(), this.options, transformOptions$2(options));
    }
    ...
    if (!this.options.isClone) {
      if (this.modules.logger) {
        baseLogger$2.init(createClassOnDemand(this.modules.logger), this.options);
      } else {
        baseLogger$2.init(null, this.options);
      }

      var lu = new LanguageUtil$2(this.options);
      this.store = new ResourceStore$4(this.options.resources, this.options);

      var s = this.services;
      s.logger = baseLogger$2;
      s.resourceStore = this.store;
      s.resourceStore.on('added removed', function (lng, ns) {
        s.cacheConnector.save();
      });
      s.languageUtils = lu;
      s.pluralResolver = new PluralResolver$4(lu, { prepend: this.options.pluralSeparator, compatibilityJSON: this.options.compatibilityJSON });
      s.interpolator = new Interpolator$4(this.options);

      s.backendConnector = new Connector$4(createClassOnDemand(this.modules.backend), s.resourceStore, s, this.options);
      // pipe events from backendConnector
      s.backendConnector.on('*', function (event) {
        var arguments$1 = arguments;
      ...
      s.cacheConnector = new Connector$5(createClassOnDemand(this.modules.cache), s.resourceStore, s, this.options);
      // pipe events from backendConnector
      s.cacheConnector.on('*', function (event) {
        var arguments$1 = arguments;
      ...
      this.translator = new Translator$4(this.services, this.options);
      // pipe events from translator
      this.translator.on('*', function (event) {
        var arguments$1 = arguments;
    ...
    // TODO: COMPATIBILITY remove this
    if (this.options.compatibilityAPI === 'v1') { appendBackwardsAPI$2(this); }
  ...
  I18n.prototype.loadResources = function loadResources() {
    ...
    var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : noop$4;
    ...
    if (!this.options.resources) {
      ...
      if ((typeof _ret === 'undefined' ? 'undefined' : _typeof$6(_ret)) === "object") { return _ret.v; }
    } else {
      callback(null);
    }
  };
  ...
  I18n.prototype.use = function use(module) {
    ...
    if (module.type === 'postProcessor') {
      postProcessor$2.addPostProcessor(module);
    }
  ...
  I18n.prototype.cloneInstance = function cloneInstance() {
    ...
    var mergedOptions = _extends$12({}, options, this.options, { isClone: true });
    var clone = new I18n(mergedOptions, callback);
    var membersToCopy = ['store', 'services', 'language'];
    membersToCopy.forEach(function (m) {
      clone[m] = _this7[m];
    });
    clone.translator = new Translator$4(clone.services, clone.options);
    clone.translator.on('*', function (event) {
      var arguments$1 = arguments;
...
var Shape = (function (BaseClass$$1) {
  function Shape(tagName) {
    ...
    this._labelRotate = constant$5(0);
...
function(d, i, shape) {
  ...
  */
  Shape.prototype.labelRotate = function labelRotate (_) {
    return arguments.length
         ? (this._labelRotate = typeof _ === "function" ? _ : constant$5(_), this)
         : this._labelRotate;
  };
...
var Area = (function (Shape$$1) {
  ...
  */
  Area.prototype.x = function x (_) {
    ...
    this._x = typeof _ === "function" ? _ : constant$5(_);
    this._x0 = this._x;
    return this;
  };
  ...
  */
  Area.prototype.y = function y (_) {
    ...
    this._y = typeof _ === "function" ? _ : constant$5(_);
    this._y0 = this._y;
    return this;
  };
  ...
  var loop = function ( i ) {
    ...
    Object.keys(source).forEach(function (prop) {
      ...
      if (isObject$3(value)) {
        ...
        if (target.hasOwnProperty(prop) && isObject$3(target[prop])) { target[prop] = assign$6(target[prop], value); }
        else { target[prop] = value; }
        ...
        if (target.hasOwnProperty(prop) && Array.isArray(target[prop])) {
          ...
          value.forEach(function (sourceItem, itemIndex) {
            ...
            if (itemIndex < targetArray.length) {
              ...
              if (isObject$3(targetItem) && isObject$3(sourceItem) || Array.isArray(targetItem) && Array.isArray(sourceItem)) {
                targetArray[itemIndex] = assign$6(targetItem, sourceItem);
              }
              else { targetArray[itemIndex] = sourceItem; }
...
/**
    ...
    @desc An abstract class that contains some global methods and functionality.
*/
var BaseClass$6 = function BaseClass() {
  this._on = {};
...
/**
    ...
    @param {Object} [params.update = {}] A collection of key/value pairs that map to attributes to be given on update.
*/
var elem$3 = function(selector$$1, p) {
...
var Logger$3 = function () {
  function Logger(concreteLogger) {
    ...
    _classCallCheck$31(this, Logger);
  ...
  Logger.prototype.init = function init(concreteLogger) {
    ...
    this.prefix = options.prefix || 'i18next:';
    this.logger = concreteLogger || consoleLogger$3;
    this.options = options;
    this.debug = options.debug === false ? false : true;
  };
  ...
  Logger.prototype.create = function create(moduleName) {
    var sub = new Logger(this.logger, _extends$19({ prefix: this.prefix + ':' + moduleName + ':' }, this.options));
...
var EventEmitter$6 = function () {
	function EventEmitter() {
		_classCallCheck$32(this, EventEmitter);
...
function makeString$3(object) {
  if (object == null) { return ''; }
  return '' + object;
}

function copy$4(a, s, t) {
  a.forEach(function (m) {
    if (s[m]) { t[m] = s[m]; }
  });
}

function getLastOfPath$3(object, path, Empty) {
  function cleanKey(key) {
    return key && key.indexOf('###') > -1 ? key.replace(/###/g, '.') : key;
  }
...
function setPath$3(object, path, newValue) {
  var _getLastOfPath = getLastOfPath$3(object, path, Object),
      obj = _getLastOfPath.obj,
      k = _getLastOfPath.k;
...
function pushPath$3(object, path, newValue, concat) {
  var _getLastOfPath2 = getLastOfPath$3(object, path, Object),
      obj = _getLastOfPath2.obj,
      k = _getLastOfPath2.k;
...
function getPath$3(object, path) {
  var _getLastOfPath3 = getLastOfPath$3(object, path),
      obj = _getLastOfPath3.obj,
      k = _getLastOfPath3.k;
...
function deepExtend$3(target, source, overwrite) {
  for (var prop in source) {
    if (prop in target) {
      // If we reached a leaf string in target or source then replace with source or skip depending on the 'overwrite' switch
      if (typeof target[prop] === 'string' || target[prop] instanceof String || typeof source[prop] === 'string' || source[prop] instanceof String) {
        ...
        deepExtend$3(target[prop], source[prop], overwrite);
      }
    } else {
      target[prop] = source[prop];
    }
...
var ResourceStore$6 = function (_EventEmitter) {
  _inherits$16(ResourceStore, _EventEmitter);

  function ResourceStore() {
    var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { ns: ['translation'], defaultNS: 'translation' };

    _classCallCheck$33(this, ResourceStore);
  ...
  ResourceStore.prototype.getResource = function getResource(lng, ns, key) {
    ...
    return getPath$3(this.data, path);
  };
  ...
  ResourceStore.prototype.addResource = function addResource(lng, ns, key, value) {
    ...
    setPath$3(this.data, path, value);
  ...
  ResourceStore.prototype.addResourceBundle = function addResourceBundle(lng, ns, resources, deep, overwrite) {
    ...
    var pack = getPath$3(this.data, path) || {};

    if (deep) {
      deepExtend$3(pack, resources, overwrite);
    } else {
      pack = _extends$20({}, pack, resources);
    }

    setPath$3(this.data, path, pack);
  ...
  ResourceStore.prototype.getResourceBundle = function getResourceBundle(lng, ns) {
    ...
    // TODO: COMPATIBILITY remove extend in v2.1.0
    if (this.options.compatibilityAPI === 'v1') { return _extends$20({}, this.getResource(lng, ns)); }
...
function convertInterpolation$3(options) {
...
function convertAPIOptions$3(options) {
  if (options.resStore) { options.resources = options.resStore; }
  ...
  options = convertInterpolation$3(options);
  if (options.defaultVariables) { options.interpolation.defaultVariables = options.defaultVariables; }
...
function convertJSONOptions$3(options) {
  options = convertInterpolation$3(options);
  options.joinArrays = '\n';
...
function convertTOptions$3(options) {
  if (options.interpolationPrefix || options.interpolationSuffix || options.escapeInterpolation) {
    options = convertInterpolation$3(options);
  }
...
function appendBackwardsAPI$3(i18n) {
  i18n.lng = function () {
    baseLogger$3.deprecate('i18next.lng() can be replaced by i18next.language for detected language or i18next.languages for languages ordered by translation lookup.');
    return i18n.services.languageUtils.toResolveHierarchy(i18n.language)[0];
  };

  i18n.preload = function (lngs, cb) {
    baseLogger$3.deprecate('i18next.preload() can be replaced with i18next.loadLanguages()');
    i18n.loadLanguages(lngs, cb);
  };

  i18n.setLng = function (lng, options, callback) {
    baseLogger$3.deprecate('i18next.setLng() can be replaced with i18next.changeLanguage() or i18next.getFixedT() to get a translation function with fixed language or namespace.');
    if (typeof options === 'function') {
      callback = options;
      options = {};
    }
  ...
  i18n.addPostProcessor = function (name, fc) {
    baseLogger$3.deprecate('i18next.addPostProcessor() can be replaced by i18next.use({ type: \'postProcessor\', name: \'name\', process: fc })');
    i18n.use({
      type: 'postProcessor',
      name: name,
      process: fc
...
var Translator$6 = function (_EventEmitter) {
  _inherits$17(Translator, _EventEmitter);

  function Translator(services) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck$34(this, Translator);

    var _this = _possibleConstructorReturn$17(this, _EventEmitter.call(this));

    copy$4(['resourceStore', 'languageUtils', 'pluralResolver', 'interpolator', 'backendConnector'], services, _this);

    _this.options = options;
    _this.logger = baseLogger$3.create('translator');
    return _this;
  }
  ...
  Translator.prototype.exists = function exists(key) {
    ...
    if (this.options.compatibilityAPI === 'v1') {
      options = convertTOptions$3(options);
    }
  ...
  Translator.prototype.translate = function translate(keys) {
    ...
    if ((typeof options === 'undefined' ? 'undefined' : _typeof$10(options)) !== 'object') {
      options = this.options.overloadTranslationOptionHandler(arguments);
    } else if (this.options.compatibilityAPI === 'v1') {
      options = convertTOptions$3(options);
    }
    ...
    if (res && typeof res !== 'string' && noObject.indexOf(resType) < 0 && !(joinArrays && resType === '[object Array]')) {
      ...
      if (options.keySeparator || this.options.keySeparator) {
        ...
        for (var m in res) {
          copy$$1[m] = this$1.translate('' + key + keySeparator + m, _extends$21({ joinArrays: false, ns: namespaces }, options));
        }
        res = copy$$1;
      }
    }
  ...
  Translator.prototype.extendTranslation = function extendTranslation(res, key, options) {
    ...
    if (options.interpolation) { this.interpolator.init(_extends$21({}, options, { interpolation: _extends$21({}, this.options.interpolation, options.interpolation) })); }

    // interpolate
    var data = options.replace && typeof options.replace !== 'string' ? options.replace : options;
    if (this.options.interpolation.defaultVariables) { data = _extends$21({}, this.options.interpolation.defaultVariables, data); }
    res = this.interpolator.interpolate(res, data, this.language);
    ...
    if (res !== undefined && postProcessorNames && postProcessorNames.length && options.applyPostProcessor !== false) {
      res = postProcessor$3.handle(postProcessorNames, res, key, options, this);
    }
...
var LanguageUtil$3 = function () {
  function LanguageUtil(options) {
    _classCallCheck$35(this, LanguageUtil);

    this.options = options;

    this.whitelist = this.options.whitelist || false;
    this.logger = baseLogger$3.create('languageUtils');
  }
...
// definition http://translate.sourceforge.net/wiki/l10n/pluralforms
/* eslint-disable */
var sets$3 = [{ lngs: ['ach', 'ak', 'am', 'arn', 'br', 'fil', 'gun', 'ln', 'mfe', 'mg', 'mi', 'oc', 'tg', 'ti', 'tr', 'uz', 'wa'], nr: [1, 2], fc: 1 }, { lngs: ['af', 'an', 'ast', 'az', 'bg', 'bn', 'ca', 'da', 'de', 'dev', 'el', 'en', 'eo', 'es', 'es_ar', 'et', 'eu', 'fi', 'fo', 'fur', 'fy', 'gl', 'gu', 'ha', 'he', 'hi', 'hu', 'hy', 'ia', 'it', 'kn', 'ku', 'lb', 'mai', 'ml', 'mn', 'mr', 'nah', 'nap', 'nb', 'ne', 'nl', 'nn', 'no', 'nso', 'pa', 'pap', 'pms', 'ps', 'pt', 'pt_br', 'rm', 'sco', 'se', 'si', 'so', 'son', 'sq', 'sv', 'sw', 'ta', 'te', 'tk', 'ur', 'yo'], nr: [1, 2], fc: 2 }, { lngs: ['ay', 'bo', 'cgg', 'fa', 'id', 'ja', 'jbo', 'ka', 'kk', 'km', 'ko', 'ky', 'lo', 'ms', 'sah', 'su', 'th', 'tt', 'ug', 'vi', 'wo', 'zh'], nr: [1], fc: 3 }, { lngs: ['be', 'bs', 'dz', 'hr', 'ru', 'sr', 'uk'], nr: [1, 2, 5], fc: 4 }, { lngs: ['ar'], nr: [0, 1, 2, 3, 11, 100], fc: 5 }, { lngs: ['cs', 'sk'], nr: [1, 2, 5], fc: 6 }, { lngs: ['csb', 'pl'], nr: [1, 2, 5], fc: 7 }, { lngs: ['cy'], nr: [1, 2, 3, 8], fc: 8 }, { lngs: ['fr'], nr: [1, 2], fc: 9 }, { lngs: ['ga'], nr: [1, 2, 3, 7, 11], fc: 10 }, { lngs: ['gd'], nr: [1, 2, 3, 20], fc: 11 }, { lngs: ['is'], nr: [1, 2], fc: 12 }, { lngs: ['jv'], nr: [0, 1], fc: 13 }, { lngs: ['kw'], nr: [1, 2, 3, 4], fc: 14 }, { lngs: ['lt'], nr: [1, 2, 10], fc: 15 }, { lngs: ['lv'], nr: [1, 2, 0], fc: 16 }, { lngs: ['mk'], nr: [1, 2], fc: 17 }, { lngs: ['mnk'], nr: [0, 1, 2], fc: 18 }, { lngs: ['mt'], nr: [1, 2, 11, 20], fc: 19 }, { lngs: ['or'], nr: [2, 1], fc: 2 }, { lngs: ['ro'], nr: [1, 2, 20], fc: 20 }, { lngs: ['sl'], nr: [5, 1, 2, 3], fc: 21 }];

var _rulesPluralsTypes$3 = {
  1: function _(n) {
    return Number(n > 1);
  },
  2: function _(n) {
...
function createRules$3() {
  var l,
      rules = {};
  sets$3.forEach(function (set) {
    set.lngs.forEach(function (l) {
      return rules[l] = {
        numbers: set.nr,
        plurals: _rulesPluralsTypes$3[set.fc]
      };
    });
  });
  return rules;
...
var PluralResolver$6 = function () {
  function PluralResolver(languageUtils) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck$36(this, PluralResolver);

    this.languageUtils = languageUtils;
    this.options = options;

    this.logger = baseLogger$3.create('pluralResolver');

    this.rules = createRules$3();
  }
  ...
  PluralResolver.prototype.getSuffix = function getSuffix(code, count) {
    ...
    if (rule) {
      ...
      if ((typeof _ret === 'undefined' ? 'undefined' : _typeof$11(_ret)) === "object") { return _ret.v; }
    } else {
      this.logger.warn('no plural rule found for: ' + code);
      return '';
    }
...
var Interpolator$6 = function () {
  function Interpolator() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck$37(this, Interpolator);

    this.logger = baseLogger$3.create('interpolator');
  ...
  Interpolator.prototype.init = function init() {
    ...
    if (reset) {
      ...
      this.escape = options.interpolation && options.interpolation.escape || escape$3;
    }
    if (!options.interpolation) { options.interpolation = { escapeValue: true }; }
    ...
    this.prefix = iOpts.prefix ? regexEscape$3(iOpts.prefix) : iOpts.prefixEscaped || '{{';
    this.suffix = iOpts.suffix ? regexEscape$3(iOpts.suffix) : iOpts.suffixEscaped || '}}';
    this.formatSeparator = iOpts.formatSeparator ? regexEscape$3(iOpts.formatSeparator) : iOpts.formatSeparator || ',';

    this.unescapePrefix = iOpts.unescapeSuffix ? '' : iOpts.unescapePrefix || '-';
    this.unescapeSuffix = this.unescapePrefix ? '' : iOpts.unescapeSuffix || '';

    this.nestingPrefix = iOpts.nestingPrefix ? regexEscape$3(iOpts.nestingPrefix) : iOpts.nestingPrefixEscaped || regexEscape$3('$t(');
    this.nestingSuffix = iOpts.nestingSuffix ? regexEscape$3(iOpts.nestingSuffix) : iOpts.nestingSuffixEscaped || regexEscape$3(')');
  ...
  Interpolator.prototype.interpolate = function interpolate(str, data, lng) {
    ...
    var handleFormat = function handleFormat(key) {
      if (key.indexOf(_this.formatSeparator) < 0) { return getPath$3(data, key); }

      var p = key.split(_this.formatSeparator);
      var k = p.shift().trim();
      var f = p.join(_this.formatSeparator).trim();

      return _this.format(getPath$3(data, k), f, lng);
    };
    ...
    while (match = this.regexp.exec(str)) {
      value = handleFormat(match[1].trim());
      if (typeof value !== 'string') { value = makeString$3(value); }
      if (!value) {
        this$1.logger.warn('missed to pass in variable ' + match[1] + ' for interpolating ' + str);
        value = '';
      }
...
var Connector$6 = function (_EventEmitter) {
  _inherits$18(Connector, _EventEmitter);

  function Connector(backend, store, services) {
    var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

    _classCallCheck$38(this, Connector);
    ...
    _this.services = services;
    _this.options = options;
    _this.logger = baseLogger$3.create('backendConnector');
  ...
  Connector.prototype.loaded = function loaded(name, err, data) {
    ...
    var _name$split = name.split('|'),
        _name$split2 = _slicedToArray$3(_name$split, 2),
        lng = _name$split2[0],
        ns = _name$split2[1];
    ...
    // callback if ready
    this.queue.forEach(function (q) {
      pushPath$3(q.loaded, [lng], ns);
      remove$4(q.pending, name);
  ...
  Connector.prototype.load = function load(languages, namespaces, callback) {
    ...
    var options = _extends$22({}, this.backend.options, this.options.backend);
    ...
    if (options.allowMultiLoading && this.backend.readMulti) {
      this.read(toLoad.toLoadLanguages, toLoad.toLoadNamespaces, 'readMulti', null, null, function (err, data) {
        ...
        toLoad.toLoad.forEach(function (name) {
          var _name$split3 = name.split('|'),
              _name$split4 = _slicedToArray$3(_name$split3, 2),
              l = _name$split4[0],
              n = _name$split4[1];

          var bundle = getPath$3(data, [l, n]);
          if (bundle) {
            _this5.loaded(name, err, bundle);
          } else {
            var _err = 'loading namespace ' + n + ' for language ' + l + ' via multiloading failed';
    ...
    // load one by one
        ...
        (function () {
          var readOne = function readOne(name) {
            ...
            var _name$split5 = name.split('|'),
                _name$split6 = _slicedToArray$3(_name$split5, 2),
                lng = _name$split6[0],
                ns = _name$split6[1];
    ...
    // load one by one
        ...
        (function () {
          var readOne = function readOne(name) {
            ...
            var _name$split7 = name.split('|'),
                _name$split8 = _slicedToArray$3(_name$split7, 2),
                lng = _name$split8[0],
                ns = _name$split8[1];
...
var Connector$7 = function (_EventEmitter) {
  _inherits$19(Connector, _EventEmitter);

  function Connector(cache, store, services) {
    var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

    _classCallCheck$39(this, Connector);

    var _this = _possibleConstructorReturn$19(this, _EventEmitter.call(this));

    _this.cache = cache;
    _this.store = store;
    _this.services = services;
    _this.options = options;
    _this.logger = baseLogger$3.create('cacheConnector');
  ...
  Connector.prototype.load = function load(languages, namespaces, callback) {
    ...
    if (!this.cache) { return callback && callback(); }
    var options = _extends$23({}, this.cache.options, this.options.cache);
...
function transformOptions$3(options) {
  // create namespace object if namespace is passed in as string
  if (typeof options.ns === 'string') { options.ns = [options.ns]; }
  if (typeof options.fallbackLng === 'string') { options.fallbackLng = [options.fallbackLng]; }
  if (typeof options.fallbackNS === 'string') { options.fallbackNS = [options.fallbackNS]; }
...
var I18n$3 = function (_EventEmitter) {
  _inherits$15(I18n, _EventEmitter);

  function I18n() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var callback = arguments[1];

    _classCallCheck$30(this, I18n);

    var _this = _possibleConstructorReturn$15(this, _EventEmitter.call(this));

    _this.options = transformOptions$3(options);
    _this.services = {};
    _this.logger = baseLogger$3;
    _this.modules = {};
  ...
  I18n.prototype.init = function init(options, callback) {
    ...
    if (options.compatibilityAPI === 'v1') {
      this.options = _extends$18({}, get$5(), transformOptions$3(convertAPIOptions$3(options)), {});
    } else if (options.compatibilityJSON === 'v1') {
      this.options = _extends$18({}, get$5(), transformOptions$3(convertJSONOptions$3(options)), {});
    } else {
      this.options = _extends$18({}, get$5(), this.options, transformOptions$3(options));
    }
    ...
    if (!this.options.isClone) {
      if (this.modules.logger) {
        baseLogger$3.init(createClassOnDemand(this.modules.logger), this.options);
      } else {
        baseLogger$3.init(null, this.options);
      }

      var lu = new LanguageUtil$3(this.options);
      this.store = new ResourceStore$6(this.options.resources, this.options);

      var s = this.services;
      s.logger = baseLogger$3;
      s.resourceStore = this.store;
      s.resourceStore.on('added removed', function (lng, ns) {
        s.cacheConnector.save();
      });
      s.languageUtils = lu;
      s.pluralResolver = new PluralResolver$6(lu, { prepend: this.options.pluralSeparator, compatibilityJSON: this.options.compatibilityJSON });
      s.interpolator = new Interpolator$6(this.options);

      s.backendConnector = new Connector$6(createClassOnDemand(this.modules.backend), s.resourceStore, s, this.options);
      // pipe events from backendConnector
      s.backendConnector.on('*', function (event) {
        var arguments$1 = arguments;
      ...
      s.cacheConnector = new Connector$7(createClassOnDemand(this.modules.cache), s.resourceStore, s, this.options);
      // pipe events from backendConnector
      s.cacheConnector.on('*', function (event) {
        var arguments$1 = arguments;
      ...
      this.translator = new Translator$6(this.services, this.options);
      // pipe events from translator
      this.translator.on('*', function (event) {
        var arguments$1 = arguments;
    ...
    // TODO: COMPATIBILITY remove this
    if (this.options.compatibilityAPI === 'v1') { appendBackwardsAPI$3(this); }
  ...
  I18n.prototype.loadResources = function loadResources() {
    ...
    var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : noop$5;
    ...
    if (!this.options.resources) {
      ...
      if ((typeof _ret === 'undefined' ? 'undefined' : _typeof$9(_ret)) === "object") { return _ret.v; }
    } else {
      callback(null);
    }
  };
  ...
  I18n.prototype.use = function use(module) {
    ...
    if (module.type === 'postProcessor') {
      postProcessor$3.addPostProcessor(module);
    }
  ...
  I18n.prototype.cloneInstance = function cloneInstance() {
    ...
    var mergedOptions = _extends$18({}, options, this.options, { isClone: true });
    var clone = new I18n(mergedOptions, callback);
    var membersToCopy = ['store', 'services', 'language'];
    membersToCopy.forEach(function (m) {
      clone[m] = _this7[m];
    });
    clone.translator = new Translator$6(clone.services, clone.options);
    clone.translator.on('*', function (event) {
      var arguments$1 = arguments;
...
var Legend = (function (BaseClass$$1) {
  function Legend() {
    ...
    this._duration = 600;
    this._height = 200;
    this._id = accessor$3("id");
    this._label = accessor$3("id");
    this._lineData = [];
    this._outerBounds = {width: 0, height: 0, x: 0, y: 0};
    this._padding = 5;
  ...
  */
  Legend.prototype.render = function render (callback) {
    ...
    // Shape <g> Group
    this._group = elem$3("g.d3plus-Legend", {parent: this._select});
  ...
  if (this._tooltip) {
    ...
    this._tooltipClass.data([d])
      .footer(this._drawDepth < this._groupBy.length - 1
            ...
            ? locale$1.t("Click to Remove Highlight", {lng: this._locale})
            : locale$1.t("Click to Highlight", {lng: this._locale})
            : locale$1.t("Click to Highlight", {lng: this._locale}))
...
function value(d) {
  ...
  */
  Pie.prototype.value = function value (_) {
    return arguments.length
         ? (this._value = typeof _ === "function" ? _ : constant$2(_), this)
         : this._value;
  };
...
var Treemap = (function (Viz$$1) {
  ...
  */
  Treemap.prototype.padding = function padding (_) {
    return arguments.length
         ? (this._padding = typeof _ === "function" ? _ : constant$2(_), this)
         : this._padding;
  };
...
function sum(d) {
  ...
  */
  Treemap.prototype.sum = function sum (_) {
    return arguments.length
         ? (this._sum = typeof _ === "function" ? _ : constant$2(_), this)
         : this._sum;
  };
