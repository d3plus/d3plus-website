/*
  ...
  @license MIT
*/
if(typeof Object.assign!=="function"){Object.defineProperty(Object,"assign",{value:function e(r){"use strict";if(r===null){throw new TypeError("Cannot convert undefined or null to object")}var t=Object(r);for(var a=1;a<arguments.length;a++){var n=arguments[a];if(n!==null){for(var i in n){if(Object.prototype.hasOwnProperty.call(n,i)){t[i]=n[i]}}}}return t},writable:true,configurable:true})}if(!Array.prototype.includes){Object.defineProperty(Array.prototype,"includes",{value:function e(r,t){var a=Object(this);var n=a.length>>>0;if(n===0)return false;var i=t|0;var o=Math.max(i>=0?i:n-Math.abs(i),0);function s(e,r){return e===r||typeof e==="number"&&typeof r==="number"&&isNaN(e)&&isNaN(r)}while(o<n){if(s(a[o],r)){return true}o++}return false}})}(function(e,r){typeof exports==="object"&&typeof module!=="undefined"?r(exports,require("d3-format")):typeof define==="function"&&define.amd?define("d3plus-format",["exports","d3-format"],r):r(e.d3plus={},e.d3Format)})(this,function(e,p){"use strict";var m={"en-GB":{separator:"",suffixes:["y","z","a","f","p","n","µ","m","","k","M","B","t","q","Q","Z","Y"],grouping:[3],delimiters:{thousands:",",decimal:"."},currency:["£",""]},"en-US":{separator:"",suffixes:["y","z","a","f","p","n","µ","m","","k","M","B","t","q","Q","Z","Y"],grouping:[3],delimiters:{thousands:",",decimal:"."},currency:["$",""]},"es-ES":{separator:"",suffixes:["y","z","a","f","p","n","µ","m","","k","mm","b","t","q","Q","Z","Y"],grouping:[3],delimiters:{thousands:".",decimal:","},currency:["€",""]},"es-CL":{separator:"",suffixes:["y","z","a","f","p","n","µ","m","","k","M","B","t","q","Q","Z","Y"],grouping:[3],delimiters:{thousands:".",decimal:","},currency:["$",""]},"et-EE":{separator:" ",suffixes:["y","z","a","f","p","n","µ","m","","tuhat","miljonit","miljardit","triljonit","q","Q","Z","Y"],grouping:[3],delimiters:{thousands:" ",decimal:","},currency:["","eurot"]},"fr-FR":{suffixes:["y","z","a","f","p","n","µ","m","","k","m","b","t","q","Q","Z","Y"],grouping:[3],delimiters:{thousands:" ",decimal:","},currency:["€",""]}};var i=function(e,r){return parseFloat(Math.round(e*Math.pow(10,r))/Math.pow(10,r)).toFixed(r)};function d(e,r,t){var a=0;if(e){if(e<0){e*=-1}a=1+Math.floor(1e-12+Math.log(e)/Math.LN10);a=Math.max(-24,Math.min(24,Math.floor((a-1)/3)*3))}var n=t[8+a/3];return{number:i(n.scale(e),r),symbol:n.symbol}}function y(e,r){var t=Math.pow(10,Math.abs(8-r)*3);return{scale:r>8?function(e){return e/t}:function(e){return e*t},symbol:e}}function r(e,r){if(r===void 0)r="en-US";if(isFinite(e)){e*=1}else{return"N/A"}var t=e.toString().split(".")[0].replace("-","").length,a=typeof r==="object"?r:m[r]||m["en-US"],n=a.suffixes.map(y);var i=a.delimiters.decimal||".",o=a.separator||"";var s=p.formatLocale({currency:a.currency||["$",""],decimal:i,grouping:a.grouping||[3],thousands:a.delimiters.thousands||","});var u;if(e===0){u="0"}else if(t>=3){var f=d(s.format(".3r")(e),2,n);var l=parseFloat(f.number).toString().replace(".",i);var c=f.symbol;u=""+l+o+c}else if(t===3){u=s.format(",f")(e)}else if(e<1&&e>-1){u=s.format(".2g")(e)}else{u=s.format(".3g")(e)}return u.replace(/(\.[1-9]*)[0]*$/g,"$1").replace(/[.]$/g,"")}e.formatAbbreviate=r;Object.defineProperty(e,"__esModule",{value:true})});